      ...
      <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl border border-[#E5E7EB] p-6 space-y-4 animate-in zoom-in-95 duration-200">
        ...
        <div className="space-y-3 text-xs">
          <div className="flex justify-between py-1 border-b border-gray-100">
            ...
            <span className="font-mono font-bold text-[#0D47A1]">{appointment.id}</span>
          </div>
          <div className="flex justify-between py-1 border-b border-gray-100">
            <span className="text-[#64748B]">Patient Name</span>
            <span className="font-bold text-[#111827]">
              {appointment.patientName} ({appointment.gender}/{appointment.age}Y)
            </span>
          </div>
          <div className="flex justify-between py-1 border-b border-gray-100">
          ...
          <div className="flex justify-between py-1 border-b border-gray-100">
            ...
            <span className="font-medium text-[#111827]">{appointment.type}</span>
          </div>
          <div className="flex justify-between py-1 border-b border-gray-100">
            <span className="text-[#64748B]">Status</span>
            <span className="font-semibold text-[#66BB6A]">{appointment.status}</span>
          </div>
          <div className="py-1">
            <span className="text-[#64748B] block text-[11px]">Chief Complaint</span>
            <p className="text-slate-700 font-medium mt-0.5">{appointment.complaint}</p>
          </div>
        </div>
