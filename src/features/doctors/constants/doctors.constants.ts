import type { DoctorRecord, DoctorAppointment, DoctorPatient, WeeklySchedule, DoctorTimeline, VitalSign, Medication, PrescriptionRecord } from "../types/doctors.types";
