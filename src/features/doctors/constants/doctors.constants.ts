import type { DoctorRecord, DoctorAppointment, DoctorPatient, WeeklySchedule, DoctorTimeline, VitalSign, Medication, PrescriptionRecord, MedicineDetail } from "../types/doctors.types";
...
export const MOCK_DOCTOR_TIMELINE: DoctorTimeline[] = [
  { time: "Today, 10:30 AM", title: "Appointment Completed", desc: "OPD consultation completed for Sarah Mitchell (PT-2024-001).", icon: "CheckCircle2" as unknown as React.ElementType, type: "appointment" },
  { time: "Today, 09:15 AM", title: "Prescription Issued", desc: "Issued Rx-2024-104 (Lisinopril 10mg, Atorvastatin 20mg).", icon: "FileText" as unknown as React.ElementType, type: "prescription" },
  { time: "Yesterday, 04:30 PM", title: "Schedule Updated", desc: "OPD Availability schedule updated for current month by Hospital Admin.", icon: "Clock" as unknown as React.ElementType, type: "schedule" },
  { time: "Mar 20, 2024, 02:15 PM", title: "Profile Updated", desc: "Consultation fee and OPD Room details updated by Admin.", icon: "Edit" as unknown as React.ElementType, type: "profile" },
  { time: "Jan 15, 2020, 09:00 AM", title: "Doctor Registered", desc: "Doctor onboarded into HMS under Cardiology Department (MCI-REG-847291).", icon: "Stethoscope" as unknown as React.ElementType, type: "registration" },
];
...
export const VITALS_DATA: VitalSign[] = [
  { label: "Blood Pressure", value: "145/92", unit: "mmHg", Icon: "Activity" as unknown as React.ElementType, status: "high", color: "#EF4444", normal: "120/80" },
  { label: "Heart Rate", value: "88", unit: "bpm", Icon: "Heart" as unknown as React.ElementType, status: "normal", color: "#009688", normal: "60–100" },
  { label: "Temperature", value: "37.2", unit: "°C", Icon: "Thermometer" as unknown as React.ElementType, status: "normal", color: "#009688", normal: "36.5–37.5" },
  { label: "SpO₂", value: "97", unit: "%", Icon: "Droplets" as unknown as React.ElementType, status: "normal", color: "#009688", normal: ">95" },
];
...
export const MY_PRESCRIPTIONS_DATA: PrescriptionRecord[] = [
  { id: "RX-2026-0891", patientName: "Sarah Mitchell", mrn: "MRN-892101", consultationId: "CNS-1001", department: "Cardiology", consultationDate: "24 Jul 2026", medicineCount: 4, followup: true, followupDate: "31 Jul 2026", status: "Issued", doctorName: "Dr. Arjun Mehta", diagnosis: "Angina Pectoris, unspecified (I20.9)", medicinesList: [{ name: "Amlodipine", dose: "5mg", freq: "Once Daily" }, { name: "Metformin", dose: "500mg", freq: "Twice Daily" }, { name: "Atorvastatin", dose: "20mg", freq: "Once Nightly" }, { name: "Aspirin", dose: "75mg", freq: "Once Daily" }] },
  { id: "RX-2026-0888", patientName: "James Thornton", mrn: "MRN-772102", consultationId: "CNS-1004", department: "Cardiology", consultationDate: "24 Jul 2026", medicineCount: 2, followup: true, followupDate: "07 Aug 2026", status: "Draft", doctorName: "Dr. Arjun Mehta", diagnosis: "Essential Hypertension (I10)", medicinesList: [{ name: "Ramipril", dose: "2.5mg", freq: "Once Daily" }, { name: "Hydrochlorothiazide", dose: "12.5mg", freq: "Once Daily Morning" }] },
  { id: "RX-2026-0872", patientName: "Marcus Brown", mrn: "MRN-551980", consultationId: "CNS-0988", department: "Cardiology", consultationDate: "23 Jul 2026", medicineCount: 3, followup: false, status: "Completed", doctorName: "Dr. Arjun Mehta", diagnosis: "Type 2 Diabetes Mellitus (E11.9)", medicinesList: [{ name: "Glyburide", dose: "5mg", freq: "Twice Daily" }, { name: "Metformin", dose: "1000mg", freq: "Twice Daily" }, { name: "Empagliflozin", dose: "10mg", freq: "Once Daily" }] },
  { id: "RX-2026-0865", patientName: "Robert Chen", mrn: "MRN-442890", consultationId: "CNS-0975", department: "Cardiology", consultationDate: "22 Jul 2026", medicineCount: 2, followup: true, followupDate: "05 Aug 2026", status: "Issued", doctorName: "Dr. Arjun Mehta", diagnosis: "Hyperlipidemia, unspecified (E78.5)", medicinesList: [{ name: "Rosuvastatin", dose: "10mg", freq: "Once Nightly" }, { name: "Ezetimibe", dose: "10mg", freq: "Once Daily" }] },
  { id: "RX-2026-0850", patientName: "Emma Reyes", mrn: "MRN-331002", consultationId: "CNS-0960", department: "Cardiology", consultationDate: "21 Jul 2026", medicineCount: 5, followup: false, status: "Cancelled", doctorName: "Dr. Arjun Mehta", diagnosis: "Chest Pain, unspecified (R07.9)", medicinesList: [{ name: "Pantoprazole", dose: "40mg", freq: "Once Daily" }, { name: "Antacid Gel", dose: "10ml", freq: "TID PRN" }] },
  { id: "RX-2026-0812", patientName: "David Walsh", mrn: "MRN-112093", consultationId: "CNS-0910", department: "Cardiology", consultationDate: "18 Jul 2026", medicineCount: 1, followup: false, status: "Archived", doctorName: "Dr. Arjun Mehta", diagnosis: "Acute Coronary Syndrome follow up", medicinesList: [{ name: "Clopidogrel", dose: "75mg", freq: "Once Daily" }] },
];

export const FREQUENCY_OPTIONS = ["Once Daily", "Twice Daily", "Three Times Daily", "Every 6 Hours", "Every 8 Hours", "SOS", "Custom"];

export const ROUTE_OPTIONS = ["Oral", "Injection", "IV", "Topical", "Eye Drops", "Ear Drops", "Nasal", "Inhalation"];

export const COMMON_MEDICINES = ["Amlodipine", "Metformin", "Atorvastatin", "Aspirin", "Ramipril", "Hydrochlorothiazide", "Rosuvastatin", "Pantoprazole", "Clopidogrel", "Losartan", "Omeprazole", "Amoxicillin", "Paracetamol", "Ibuprofen"];
