export { DoctorAppointmentsScreen } from "../components/DoctorAppointmentsScreen";
export { DoctorConsultationScreen } from "../components/DoctorConsultationScreen";
export { DoctorPrescriptionsScreen } from "../components/DoctorPrescriptionsScreen";
