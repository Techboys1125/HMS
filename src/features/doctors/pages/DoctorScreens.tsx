...
export function DoctorEditPrescriptionScreen({
  ...
  const [chiefComplaint, setChiefComplaint] = useState(
    "Bilateral ankle swelling and mild morning headaches for 2 weeks.",
  );
  const [clinicalFindings, setClinicalFindings] = useState(
    "BP 152/94 mmHg, HR 76 bpm. Mild pedal edema (+1). S1 S2 normal.",
  );
  ...
  const [clinicalNotes, setClinicalNotes] = useState(
    "Adjusting antihypertensive therapy. Routine renal function tests advised in 2 weeks.",
  );
  ...
  const [dietAdvice, setDietAdvice] = useState(
    "Low salt intake (< 2g/day), restrict caffeine and canned foods.",
  );
  const [lifestyleAdvice, setLifestyleAdvice] = useState(
    "Daily BP monitoring twice daily (morning & evening). Log readings.",
  );
  const [exerciseAdvice, setExerciseAdvice] = useState(
    "Moderate 30-min brisk walking 5 days a week.",
  );
  const [specialInstructions, setSpecialInstructions] = useState(
    "If experiencing severe dizziness or SBP > 180 mmHg, contact clinic immediately.",
  );
  ...
  const [followupNotes, setFollowupNotes] = useState(
    "Review home BP log and serum electrolytes.",
  );
  ...
  const validateForm = () => {
    ...
    medicines.forEach((m, idx) => {
      if (!m.name.trim())
        errs[`med_${m.id}_name`] = `Medicine #${idx + 1} name required`;
      if (!m.dosage.trim()) errs[`med_${m.id}_dosage`] = `Dosage required`;
      if (!m.frequency.trim())
        errs[`med_${m.id}_frequency`] = `Frequency required`;
      if (!m.duration.trim())
        errs[`med_${m.id}_duration`] = `Duration required`;
    });
  ...
  return (
    <div className="flex-1 bg-[#F1F5F9] overflow-y-auto flex flex-col font-sans relative pb-24">
      ...
      {toastMsg && (
        <div
          className="fixed bottom-16 right-5 z-50 bg-[#111827] text-white px-4 py-2.5 rounded-xl shadow-lg text-xs font-medium flex items-center gap-2 animate-bounce"
          style={{ fontFamily: RB }}
        >
          <CheckCircle2 size={15} className="text-[#66BB6A]" />
          {toastMsg}
            ...
            <Card className="p-5">
              <div className="flex items-center gap-2 mb-4 pb-3 border-b border-gray-100">
                ...
                <h3
                  ...
                  style={{ fontFamily: PP }}
                >
                  Follow-up Details (Editable)
                </h3>
              </div>

              <div
                className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs mb-3"
                style={{ fontFamily: RB }}
              >
                <div>
                  <label
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <Card className="p-4">
              ...
              <div className="space-y-2">
                ...
                <button
                  onClick={() =>
                    showToast(`Downloaded PDF for ${prescriptionId}`)
                  }
                  className="w-full flex items-center justify-between px-3 py-2 rounded-xl border border-gray-200 hover:bg-slate-50 text-slate-700 text-xs font-medium transition-colors"
                  style={{ fontFamily: RB }}
                >
                ...
                <button
                  onClick={() =>
                    onViewConsultation?.(patientData.consultationId)
                  }
                  className="w-full flex items-center justify-between px-3 py-2 rounded-xl border border-gray-200 hover:bg-slate-50 text-slate-700 text-xs font-medium transition-colors"
                  style={{ fontFamily: RB }}
                >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="bg-white rounded-2xl max-w-lg w-full p-6 shadow-2xl border border-gray-100 animate-in zoom-in-95 duration-150">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <strong>Patient:</strong> {patientData.patientName}
                </div>
                <div>
                ...
                <div>
                  <strong>Date:</strong> {patientData.consultationDate}
                </div>
              </div>
              <div>
                <strong>Diagnosis:</strong> {finalDiagnosis}
              </div>
              <div className="pt-2 border-t border-gray-200">
                <div className="font-bold mb-1">
...
export function DoctorPrescriptionPrintPreviewScreen({
  ...
  const docData = {
    ...
    chiefComplaint:
      "Severe chest tightness radiating to left shoulder with acute dyspnea on exertion.",
    clinicalFindings:
      "Chest wall non-tender. S1 and S2 heart sounds heard normal. BP 145/92 mmHg, HR 88 bpm.",
    finalDiagnosis: "Angina Pectoris, unspecified",
    icdCode: "I20.9 — Angina Pectoris, unspecified",
    ...
    // Advice
    dietAdvice:
      "Strict low-sodium (< 2g/day), low saturated fat diet. Increase fiber intake.",
    lifestyleAdvice:
      "Smoking cessation strictly advised. Avoid stress and maintain regular sleep hygiene (7-8 hours).",
    ...
    nextVisitDate: "31 Jul 2026",
    followupNotes:
      "Review ECG & Troponin-I laboratory reports. Re-evaluate blood pressure control.",
  };

  // Handle Browser Triggered Print
  const handlePrint = () => {
    showToast(
      `Sending ${copies} copy (${paperSize}, ${colorMode}) of ${prescriptionId} to printer...`,
    );
    setTimeout(() => {
      window.print();
    }, 500);
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p
              ...
              style={{ fontFamily: RB }}
            >
              Preview the prescription exactly as it will appear when printed or
              downloaded.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-8 xl:col-span-9 flex justify-center">
            ...
            >
              ...
              <div className="flex justify-between items-start pb-4 border-b-2 border-[#0D47A1]">
                ...
                <div className="text-right">
                  ...
                  <span className="font-mono text-xs font-semibold text-slate-700">
                    {docData.hospitalRegNo}
                  </span>
                  <div
                    className="mt-2 inline-block px-2.5 py-0.5 rounded bg-blue-50 text-[#0D47A1] text-[10px] font-bold uppercase tracking-wider"
                    style={{ fontFamily: PP }}
                  >
                    OPD Prescription
                  </div>
              ...
              <div
                className="my-5 p-4 bg-slate-50 rounded-xl border border-gray-200 grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs"
                style={{ fontFamily: RB }}
              >
                <div>
                  <span
                ...
                <div className="col-span-2 sm:col-span-4 pt-3 border-t border-gray-200 grid grid-cols-2 sm:grid-cols-4 gap-3">
                  ...
                  <div>
                    ...
                    <span className="font-medium text-slate-700">
                      {docData.age} yrs / {docData.gender}
                    </span>
                  </div>
                  <div>
                    <span
              ...
              <div
                className="mb-5 px-4 py-2.5 bg-blue-50/50 rounded-lg border border-blue-100 flex items-center justify-between text-xs"
                style={{ fontFamily: RB }}
              >
                <div>
                  <span
                  ...
                  <span className="text-[#0D47A1] ml-2 font-medium">
                    ({docData.department})
                  </span>
                </div>
                <div className="text-right">
              ...
              >
                <h3
                  className="text-xs font-bold text-[#0D47A1] uppercase tracking-wider border-b border-gray-200 pb-1"
                  style={{ fontFamily: PP }}
                >
                  Clinical Diagnosis
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                  ...
                  <div className="col-span-2 flex items-center gap-3 bg-slate-50 p-2.5 rounded-lg border border-gray-100">
                    <span
                      className="text-[10px] font-bold text-slate-400 uppercase shrink-0"
                      style={{ fontFamily: PP }}
                    >
                      Final Diagnosis:
                    </span>
                    <span className="font-bold text-[#111827]">
                      {docData.finalDiagnosis}
                    </span>
                    <span className="font-mono text-[11px] bg-blue-100 text-[#0D47A1] px-2 py-0.5 rounded font-semibold ml-auto">
                      {docData.icdCode}
                    </span>
                  </div>
                </div>
              ...
              <div className="mb-6 space-y-2">
                ...
                >
                  <thead>
                    <tr
                      className="bg-slate-100 border-b border-gray-300 text-[10px] font-bold text-slate-700 uppercase"
                      style={{ fontFamily: PP }}
                    >
                      <th className="p-2">#</th>
                  ...
                  <tbody className="divide-y divide-gray-200 text-slate-800">
                    {docData.medicines.map((m, idx) => (
                      ...
                      >
                        <td className="p-2 font-mono font-bold text-slate-400 text-[11px]">
                          {idx + 1}
                        </td>
                        <td
                        ...
                        <td className="p-2 text-slate-600 italic text-[11px] max-w-xs">
                          {m.instructions}
                        </td>
                      </tr>
                    ))}
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                  ...
                  <div className="p-2.5 bg-amber-50 rounded-lg border border-amber-200">
                    <span
                      className="text-[10px] font-bold text-amber-800 uppercase block"
                      style={{ fontFamily: PP }}
                    >
                      Special Instructions
                    </span>
                    <p className="text-amber-900 font-medium">
                      {docData.specialInstructions}
                    </p>
                  </div>
                </div>
              </div>
              ...
              {/* 7. Follow-up Details */}
              <div
                className="mb-8 p-3 bg-slate-50 rounded-xl border border-gray-200 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs"
                style={{ fontFamily: RB }}
              >
                <div>
                  <span
                  ...
                  <span className="font-bold text-[#111827] text-sm">
                    Required — Next Visit Date: {docData.nextVisitDate}
                  </span>
                </div>
                <div className="text-right">
                  <span
              ...
              <div className="pt-6 border-t border-gray-300 grid grid-cols-2 gap-6 items-end mt-12">
                ...
                <div>
                  <div
                    className="w-24 h-24 border-2 border-dashed border-slate-300 rounded-full flex flex-col items-center justify-center text-center p-2 text-[9px] text-slate-400"
                    style={{ fontFamily: PP }}
                  >
                    <span className="font-bold uppercase tracking-widest text-[8px] text-slate-400">
                      HMS SEAL
                    </span>
              ...
              {/* 9. Document Footer */}
              <div
                className="mt-8 pt-3 border-t border-gray-200 text-center text-[10px] text-slate-400 flex flex-col sm:flex-row justify-between items-center gap-1"
                style={{ fontFamily: RB }}
              >
                <span>
                  This prescription was generated electronically through the HMS
                  Operations Center.
                </span>
            ...
            <Card className="p-4">
              ...
              <div className="space-y-2.5 text-xs" style={{ fontFamily: RB }}>
                ...
                <div className="flex justify-between items-center pt-2 border-t border-gray-100">
                  <span className="text-slate-500">Total Medicines</span>
                  <span className="font-bold text-[#009688]">
                    {docData.medicines.length} Medicines
                  </span>
                </div>
              </div>
            </Card>
...
export function DoctorPrescriptionHistoryScreen({
  ...
  const [expandedRxId, setExpandedRxId] = useState<string | null>(
    "RX-2026-0891",
  );
  ...
  const followupHistoryData = [
    {
      ...
      notes: "ECG & Troponin-I report review",
    },
    {
      date: "24 Jul 2026",
      status: "Completed",
      doctor: "Dr. Arjun Mehta",
      outcome: "Adjusted Rx",
      notes: "Increased Atorvastatin to 20mg",
    },
    {
      date: "10 Apr 2026",
      status: "Completed",
      doctor: "Dr. Arjun Mehta",
      outcome: "Stable",
      notes: "BP controlled at 135/85 mmHg",
    },
    {
      date: "20 Nov 2025",
      status: "Completed",
      doctor: "Dr. Priya Sharma",
      outcome: "Stable",
      notes: "HbA1c 6.4%, glucose under control",
    },
  ];
  ...
  const filteredTimeline = prescriptionHistoryData.filter((rx) => {
    const matchesSearch =
      searchRxId === "" ||
      rx.id.toLowerCase().includes(searchRxId.toLowerCase()) ||
      rx.diagnosis.toLowerCase().includes(searchRxId.toLowerCase());
    const matchesDoctor =
      selectedDoctor === "All" || rx.doctor === selectedDoctor;
    const matchesDept =
      selectedDept === "All" || rx.department === selectedDept;
    const matchesStatus =
      selectedStatus === "All" || rx.status === selectedStatus;
    const matchesMedicine =
      medicineFilter === "" ||
      rx.medicines.some((m) =>
        m.name.toLowerCase().includes(medicineFilter.toLowerCase()),
      );
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p
              ...
              style={{ fontFamily: RB }}
            >
              Review previous prescriptions, medicines and follow-up history for
              this patient.
            </p>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={() =>
                showToast(`Exported full history PDF for ${patientMrn}`)
              }
              className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl border border-[#0D47A1] bg-white text-[#0D47A1] hover:bg-blue-50 text-xs font-semibold transition-all shadow-sm"
              style={{ fontFamily: PP }}
            >
            ...
            <button
              onClick={() =>
                showToast(
                  `Sent full prescription history for ${patientMrn} to printer`,
                )
              }
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[#0D47A1] hover:bg-[#0c3d8a] text-white text-xs font-semibold transition-all shadow-sm"
              style={{ fontFamily: PP }}
            ...
            <div>
              ...
              >
                ...
                <span>
                  Primary Doctor:{" "}
                  <strong className="text-[#111827]">
                    {patientData.primaryDoctor} ({patientData.department})
                  </strong>
                </span>
                <span>•</span>
                <span>
              ...
              {isLoading ? (
                ...
                <Card className="p-8 text-center">
                  ...
                  <p
                    ...
                    style={{ fontFamily: RB }}
                  >
                    No records matched your search or filter parameters.
                  </p>
                </Card>
              ) : (
                /* Timeline Cards */
                        ...
                        <Card className="p-4 transition-all">
                          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-gray-100 pb-3">
                            ...
                            <div className="flex items-center gap-1.5 shrink-0">
                              ...
                              <button
                                onClick={() =>
                                  setExpandedRxId(isExpanded ? null : rx.id)
                                }
                                className="p-1.5 hover:bg-slate-100 text-slate-600 rounded-lg transition-colors"
                          ...
                          >
                            <div className="flex items-start gap-2">
                              <span
                                className="font-bold text-slate-400 uppercase shrink-0 text-[10px]"
                                style={{ fontFamily: PP }}
                              >
                                Diagnosis:
                              </span>
                              ...
                              {isExpanded ? (
                                <div className="space-y-1.5 bg-slate-50 p-2.5 rounded-xl border border-gray-100">
                                  {rx.medicines.map((m, idx) => (
                                    <div
                                      key={idx}
                                      className="flex justify-between items-center text-xs py-0.5 border-b border-gray-100 last:border-none"
                                    >
                                      <span
                      ...
                      >
                        ...
                        >
                          <div className="flex items-center gap-1.5">
                            ...
                            {m.isLongTerm && (
                              <span
                                className="px-1.5 py-0.2 bg-teal-50 text-[#009688] border border-teal-200 rounded text-[9px] font-bold shrink-0"
                                title="Identified as Long-Term Medication"
                              >
                                Long-Term
                              </span>
                            )}
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {diagnosisHistoryData.map((d, idx) => (
                      <tr
                        ...
                        className="hover:bg-slate-50/60 transition-colors"
                      >
                        <td className="p-2 font-mono text-slate-600 font-medium">
                          {d.date}
                        </td>
                        <td
                          className="p-2 font-bold text-[#111827]"
                        ...
                        <td className="p-2 font-mono font-semibold text-[#0D47A1]">
                          {d.icdCode}
                        </td>
            ...
            <Card className="p-4">
              ...
              <div className="space-y-2.5 text-xs" style={{ fontFamily: RB }}>
                {followupHistoryData.map((f, idx) => (
                  <div
                    key={idx}
                    className="p-3 bg-slate-50 rounded-xl border border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-2"
                  >
                    <div>
                      <div className="flex items-center gap-2">
                        <span
                          ...
                          style={{ fontFamily: PP }}
                        >
                          Follow-up Date: {f.date}
                        </span>
                        <span
                          className={`px-2 py-0.5 rounded text-[10px] font-bold ${f.status === "Scheduled" ? "bg-amber-100 text-amber-800" : "bg-emerald-100 text-emerald-800"}`}
                        >
                          {f.status}
                        </span>
                      </div>
                    ...
                    <div className="text-right shrink-0">
                      ...
                      <span className="font-semibold text-slate-700">
                        {f.doctor} •{" "}
                        <strong className="text-[#0D47A1]">{f.outcome}</strong>
                      </span>
                    </div>
                  </div>
                ))}
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <Card className="p-4">
              ...
              <div className="space-y-2">
                ...
                >
                  <span className="flex items-center gap-2">
                    <Eye size={15} /> View Latest Prescription
                  </span>
                  <ChevronRight size={14} />
                </button>
                ...
                >
                  <span className="flex items-center gap-2">
                    <Download size={15} /> Download History PDF
                  </span>
                  <ChevronRight size={14} />
                </button>
                ...
                >
                  <span className="flex items-center gap-2">
                    <User size={14} /> Open Patient Profile
                  </span>
                  <ChevronRight size={13} />
                </button>
              </div>
