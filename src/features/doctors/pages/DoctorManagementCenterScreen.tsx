...
export function DoctorProfileScreen({
  ...
  // Modals & Drawers
  const [selectedApptDetail, setSelectedApptDetail] = useState<Record<
    string,
    unknown
  > | null>(null);
            ...
            <div className="space-y-3 text-xs">
              <div className="flex justify-between py-1 border-b border-gray-100">
                ...
                <span className="font-mono font-bold text-[#0D47A1]">
                  {selectedApptDetail.id as string}
                </span>
              </div>
              <div className="flex justify-between py-1 border-b border-gray-100">
                <span className="text-[#64748B]">Patient Name</span>
                <span className="font-bold text-[#111827]">
                  {selectedApptDetail.patientName as string} (
                  {selectedApptDetail.gender as string}/
                  {selectedApptDetail.age as number}Y)
                </span>
              </div>
              <div className="flex justify-between py-1 border-b border-gray-100">
                <span className="text-[#64748B]">Date &amp; Time</span>
                <span className="font-medium text-[#111827]">
                  {selectedApptDetail.date as string} &bull;{" "}
                  {selectedApptDetail.time as string}
                </span>
              </div>
              <div className="flex justify-between py-1 border-b border-gray-100">
                <span className="text-[#64748B]">Visit Type</span>
                <span className="font-medium text-[#111827]">
                  {selectedApptDetail.type as string}
                </span>
              </div>
              <div className="flex justify-between py-1 border-b border-gray-100">
                <span className="text-[#64748B]">Status</span>
                <span className="font-semibold text-[#66BB6A]">
                  {selectedApptDetail.status as string}
                </span>
              </div>
              <div className="py-1">
                <span className="text-[#64748B] block text-[11px]">
                ...
                <p className="text-slate-700 font-medium mt-0.5">
                  {selectedApptDetail.complaint as string}
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-[#E5E7EB] p-4 shadow-sm flex items-center justify-between hover:border-blue-200 transition-colors">
              <div>
                ...
                <div className="text-[11px] text-[#0D47A1] font-medium mt-1 flex items-center gap-1">
                  <span>
                    Across {departmentsCoveredCount} clinical departments
                  </span>
                </div>
              </div>
              <div className="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center text-[#0D47A1]">
          ...
          <table className="w-full border-collapse text-left text-xs">
            <thead className="sticky top-0 bg-slate-50 border-b border-[#E5E7EB] z-10">
              ...
              >
                ...
                <th
                  onClick={() => handleSort("experienceYrs")}
                  className="px-4 py-3.5 cursor-pointer hover:text-[#0D47A1] transition-colors"
                >
                  <div className="flex items-center gap-1">
            ...
            <tbody className="divide-y divide-gray-100 text-[#111827]">
              {isLoading ? (
                  ...
                  <td colSpan={10} className="px-4 py-12 text-center">
                    <div className="flex flex-col items-center justify-center max-w-sm mx-auto space-y-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-xs text-[#64748B]">
                          No doctor records matched your search query or
                ...
                filteredDoctors.map((doc) => {
                  ...
                  const availBadge = getAvailabilityBadgeStyle(
                    doc.availability,
                  );
                ...
                <div className="flex items-center gap-4 bg-slate-50 p-4 rounded-2xl border border-[#E5E7EB]">
                  ...
                  <div className="space-y-1 overflow-hidden">
                    ...
                    <p className="text-xs text-[#0D47A1] font-bold">
                      {quickDetailsDoctor.specialty}
                    </p>
                    <p className="text-[11px] text-[#64748B]">
                      {quickDetailsDoctor.department}
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-3.5 text-xs">
                  ...
                  <div className="py-1.5 border-b border-gray-100 space-y-1">
                    ...
                    <span className="font-medium text-[#111827] block">
                      {quickDetailsDoctor.qualification}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between py-1.5 border-b border-gray-100">
                    ...
                    <span className="font-bold text-[#111827]">
                      {quickDetailsDoctor.experienceYrs} Years
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between py-1.5 border-b border-gray-100">
                    ...
                    <span
                      className={`px-2.5 py-1 rounded-full text-[11px] border font-medium ${getAvailabilityBadgeStyle(quickDetailsDoctor.availability).bg}`}
                    >
                  ...
                  <div className="flex items-center justify-between py-1.5 border-b border-gray-100">
                    <span className="text-[#64748B]">Shift Timings</span>
                    <span className="font-medium text-[#111827]">
                      {quickDetailsDoctor.shiftTimings}
                    </span>
                  </div>
                </div>
            ...
            <div className="p-5 border-b border-[#E5E7EB] bg-slate-50 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#64748B]">
                    {scheduleDoctor.name} &bull; {scheduleDoctor.opdRoom}
                  </p>
                </div>
              </div>
              <button
            ...
            <div className="p-6 space-y-5 text-xs">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-7 gap-2 text-center">
                  {["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map(
                    (day) => {
                      const isWorking =
                        scheduleDoctor.workingDays.includes(day);
                      return (
                        <div
                          key={day}
              ...
              <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-200 space-y-1">
                ...
                <p className="text-slate-600 text-[11px] leading-relaxed">
                  Doctor accepts up to 20 walk-in and pre-booked OPD
                  consultations per shift slot. Consultation duration is
                  estimated at 15 minutes per patient.
                </p>
              </div>
            </div>
