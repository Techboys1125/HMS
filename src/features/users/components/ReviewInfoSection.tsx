      ...
      <div className="bg-slate-50 border border-slate-100 rounded-2xl p-5 flex items-center gap-4">
        ...
        <div>
          <h3 className="font-heading font-bold text-sm text-slate-800">
            Recheck & Confirm Information
          </h3>
          <p className="font-body text-[11px] text-slate-400 font-medium">
            Please review the details below before saving this new staff member
            account.
          </p>
        </div>
      </div>
        ...
        <div className="bg-white border border-[#E5E7EB] rounded-2xl p-6 space-y-4 shadow-xs">
          ...
          <div className="space-y-3 text-xs">
            ...
            <div className="flex justify-between items-start py-0.5">
              ...
              <span className="text-slate-800 font-bold text-right font-mono text-[11px]">
                {form.email || "—"}
              </span>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-xs">
              ...
              <div className="text-[11px] text-slate-400 leading-relaxed pt-2">
                This user will be registered in the system with{" "}
                <span className="font-semibold text-slate-700">
                  {getDisplayRole(form.role)}
                </span>{" "}
                portals and authorizations. A dynamic system notification will
                be scheduled to deliver login details.
              </div>
            </div>
          </div>
            ...
            <div className="space-y-3 border-t border-dashed border-slate-100 pt-4 mt-4 text-xs">
              <div className="flex justify-between items-start py-0.5">
                <span className="text-slate-400 font-medium flex items-center gap-1">
                  <Building2 size={13} /> Primary Dept
                </span>
                <span className="text-slate-800 font-bold text-right">
              ...
              {form.secondaryDepartment && (
                <div className="flex justify-between items-start py-0.5">
                  <span className="text-slate-400 font-medium flex items-center gap-1">
                    <Building2 size={13} /> Secondary Dept
                  </span>
                  <span className="text-slate-800 font-bold text-right">
                    {form.secondaryDepartment}
                  </span>
              ...
              <div className="flex justify-between items-start py-0.5">
                <span className="text-slate-400 font-medium flex items-center gap-1">
                  <Briefcase size={13} /> Primary Specialty
                </span>
                <span className="text-slate-800 font-bold text-right">
              ...
              {form.secondarySpecialty && (
                <div className="flex justify-between items-start py-0.5">
                  <span className="text-slate-400 font-medium flex items-center gap-1">
                    <Briefcase size={13} /> Secondary Specialty
                  </span>
                  <span className="text-slate-800 font-bold text-right">
                    {form.secondarySpecialty}
                  </span>
        ...
        <div className="bg-white border border-[#E5E7EB] rounded-2xl p-6 space-y-4 shadow-xs">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-3 text-[11px]">
            {Object.entries(form.availability).map(([day, sched]) => (
              <div
                key={day}
                className={`border rounded-xl p-3 flex flex-col items-center gap-1.5 text-center ${
                  sched.isAvailable
