...
import type {PatientRegistrationData, PatientLinkData, PatientRegistrationResponse}
...
export function usePatientRegister(onSuccess ?:(res: PatientRegistrationResponse) => void,) {
    ...
    const register = async (data : PatientRegistrationData,) : Promise < PatientRegistrationResponse | null > => {
    ...
    const linkExisting = async (data : PatientLinkData,) : Promise < PatientRegistrationResponse | null > => {
