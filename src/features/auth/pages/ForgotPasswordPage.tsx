    ...
    <div className="w-full space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <button
          ...
          className="w-full py-4 px-6 bg-[#0D47A1] hover:bg-[#1565C0] text-white font-heading font-semibold text-base sm:text-lg rounded-2xl shadow-lg transition-transform active:scale-[0.99] disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
        >
          {loading ? (
            <>
