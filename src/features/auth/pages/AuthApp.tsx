  ...
  return (
    <div
      ...
      style={{
        ...
        minWidth: 380,
        background:
          "linear-gradient(145deg, #083a84 0%, #0D47A1 45%, #1565C0 100%)",
      }}
    >
      {/* Cross pattern */}
      <svg
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(0,150,136,0.18) 0%, transparent 65%)",
        }}
      />
      <div
        className="absolute top-1/2 -left-16 w-56 h-56 rounded-full pointer-events-none"
        style={{
          background:
            "radial-gradient(circle, rgba(77,182,172,0.1) 0%, transparent 65%)",
        }}
      />
      ...
      <div className="relative z-10 flex flex-col h-full px-10 py-10">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div
              ...
              style={{ fontFamily: RB, color: "rgba(255,255,255,0.55)" }}
            >
        ...
        <div className="mb-8">
          <h2
            className="text-white font-bold text-2xl leading-snug mb-3"
            style={{ fontFamily: PP }}
          >
            Care You Can Trust,
            <br />
          ...
          <p
            ...
            style={{ fontFamily: RB, color: "rgba(255,255,255,0.6)" }}
          >
        ...
        <div className="space-y-3 mb-8">
          {[
            ...
            <div key={f} className="flex items-center gap-3">
              ...
              <span
                className="text-sm"
                style={{ fontFamily: RB, color: "rgba(255,255,255,0.72)" }}
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span
              className="text-xs"
              style={{ fontFamily: RB, color: "rgba(255,255,255,0.5)" }}
            >
              HIPAA Compliant
            </span>
          </div>
        ...
        <div className="mt-4 text-center">
          <span
            className="text-xs"
            style={{ fontFamily: RB, color: "rgba(255,255,255,0.3)" }}
          >
            MediCore HMS v2.0.1
          </span>
        </div>
...
function HospitalIllustration() {
  return (
    <svg viewBox="0 0 280 220" fill="none" className="w-full max-w-xs">
      {/* ECG trace */}
      <path
        d="M 10 160 L 50 160 L 62 130 L 74 190 L 86 110 L 98 160 L 270 160"
        stroke="white"
        strokeOpacity="0.12"
        strokeWidth="1.5"
        strokeLinecap="round"
    ...
    <div className="space-y-1.5">
      ...
      <div className="relative">
        {Icon && (
          <Icon
            size={16}
            className={`absolute left-3.5 top-1/2 -translate-y-1/2 pointer-events-none transition-colors ${hasError ? "text-[#EF4444]" : "text-slate-400"}`}
          />
        )}
        <input
          type={type}
          ...
          autoFocus={autoFocus}
          className={`w-full py-3 text-sm rounded-xl border outline-none transition-all ${Icon ? "pl-10" : "pl-4"} ${rightElement ? "pr-11" : "pr-4"} ${
            hasError
      ...
      {hasError && (
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-xs text-[#EF4444]" style={{ fontFamily: RB }}>
            {error}
          </span>
        </div>
      )}
  ...
  return (
    <button
      ...
      style={{
        fontFamily: PP,
        boxShadow:
          disabled || loading ? "none" : "0 2px 12px rgba(13,71,161,0.25)",
      }}
    >
      {loading && (
        <svg
...
function CardLogo() {
  return (
    <div className="flex items-center gap-2.5 mb-8">
      ...
      <div>
        <div
          className="text-sm font-bold text-[#111827] leading-none"
          style={{ fontFamily: PP }}
        >
          Safe Hands Hospital
        </div>
...
function LoginScreen({
  ...
  const submit = () => {
    ...
    setTimeout(() => {
      ...
      if (email !== DEMO_EMAIL || password !== DEMO_PASSWORD) {
        setErrors({
          form: "Incorrect email or password. Please use the demo credentials below.",
        });
        return;
      }
      onLogin();
  ...
  return (
    <AuthCard>
      ...
      <div className="mb-5">
        <h1
          className="text-2xl font-bold text-[#111827] leading-tight"
          style={{ fontFamily: PP }}
        >
          Welcome back
        </h1>
        <p className="text-sm text-[#64748B] mt-1" style={{ fontFamily: RB }}>
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1.5">
            ...
            <span
              className="text-[10px] bg-[#0D47A1] text-white px-1.5 py-0.5 rounded font-semibold"
              style={{ fontFamily: RB }}
            >
              Click to fill
            </span>
          ...
          <div className="grid grid-cols-2 gap-x-4 gap-y-1">
            <div>
              <span
                className="text-[10px] text-[#64748B] block"
                style={{ fontFamily: RB }}
              >
                Email
              </span>
        ...
        <ChevronRight
          size={14}
          className="text-[#0D47A1] shrink-0 mt-2 group-hover:translate-x-0.5 transition-transform"
        />
      </button>
      ...
      {errors.form && (
        <div className="mb-4 flex items-start gap-2.5 p-3.5 bg-red-50 border border-red-100 rounded-xl">
          ...
          <span className="text-sm text-red-700" style={{ fontFamily: RB }}>
            {errors.form}
          </span>
        </div>
      )}
      ...
      >
        ...
        <div className="flex items-center justify-between mt-4 mb-6">
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            <span className="text-sm text-[#64748B]" style={{ fontFamily: RB }}>
              Remember me
            </span>
          </label>
          <button
      ...
      <div className="mt-6 pt-5 border-t border-[#E5E7EB] flex items-center justify-center gap-4">
        <button
          className="text-xs text-[#64748B] hover:text-[#0D47A1] transition-colors"
          style={{ fontFamily: RB }}
        >
          Privacy Policy
        </button>
...
function ForgotScreen({
  ...
  return (
    <AuthCard>
      ...
      <button
        onClick={onBack}
        className="flex items-center gap-1.5 text-sm text-[#64748B] hover:text-[#0D47A1] mb-6 transition-colors font-medium"
        style={{ fontFamily: RB }}
      >
      ...
      {!sent ? (
        <>
          ...
          <div className="mt-5 flex items-start gap-2 p-3.5 bg-slate-50 rounded-xl border border-[#E5E7EB]">
            ...
            <p
              ...
              style={{ fontFamily: RB }}
            >
              For security, reset links expire after 15 minutes. Contact your
              administrator if you don't receive an email.
            </p>
          </div>
        </>
      ) : (
        <>
          <div className="text-center py-4">
            ...
            <p
              className="text-sm text-[#64748B] leading-relaxed mb-1"
              style={{ fontFamily: RB }}
            >
            ...
            <p
              className="text-xs text-[#64748B] mt-3 leading-relaxed"
              style={{ fontFamily: RB }}
            >
            ...
            <div className="mt-6">
              <button
                ...
                className="w-full flex items-center justify-center gap-1.5 px-6 py-3 rounded-xl border border-[#0D47A1] text-[#0D47A1] text-sm font-semibold hover:bg-blue-50 transition-colors"
                style={{ fontFamily: PP }}
              >
  ...
  return (
    <AuthCard>
      ...
      <div className="text-center mb-7">
        <h1
          className="text-2xl font-bold text-[#111827] leading-tight mb-2"
          style={{ fontFamily: PP }}
        >
      ...
      >
        Tip: use{" "}
        <span className="font-mono font-semibold text-[#0D47A1]">123456</span>{" "}
        for demo
      </p>
    </AuthCard>
  );
          ...
          <div>
            ...
            <div className="flex items-center justify-between">
              <span
                ...
                style={{ color: config.color, fontFamily: PP }}
              >
                {config.label}
              </span>
              <span
          ...
          {PW_RULES.map((r) => {
            ...
            return (
              <div key={r.label} className="flex items-center gap-2">
                <div
                  className={`w-4 h-4 rounded-full flex items-center justify-center shrink-0 transition-all ${passed ? "bg-[#66BB6A]" : "bg-gray-100"}`}
                >
                  {passed ? (
                ...
                <span
                  className={`text-xs transition-colors ${passed ? "text-[#66BB6A] font-medium" : "text-[#64748B]"}`}
                  style={{ fontFamily: RB }}
                >
                  {r.label}
                </span>
  ...
  return (
    <AuthCard>
      ...
      <div className="text-center py-4">
        ...
        <p
          className="text-sm text-[#64748B] leading-relaxed mb-2"
          style={{ fontFamily: RB }}
        >
        ...
        <div className="flex items-center justify-center gap-1.5 mb-8 mt-4">
          ...
          <span className="text-xs text-[#64748B]" style={{ fontFamily: RB }}>
            Secure reset completed at {new Date().toLocaleTimeString()}
          </span>
        </div>
      ...
      <div className="text-center py-4">
        <div className="relative w-24 h-24 mx-auto mb-6">
          <svg viewBox="0 0 96 96" className="w-24 h-24">
            ...
            />
            <path
              d="M 62 28 L 70 22 M 62 22 L 70 28"
              stroke="#EF4444"
              strokeWidth="2"
              strokeLinecap="round"
            />
        ...
        <p
          ...
          style={{ fontFamily: RB }}
        >
          Your session has expired due to inactivity. For your security, you've
          been automatically signed out.
        </p>
        <div className="bg-amber-50 border border-amber-100 rounded-xl p-4 mb-7 text-left">
          ...
          <ul className="space-y-1">
            {[
              ...
              "Security policy automatically signed you out",
              "All unsaved changes may have been lost",
            ].map((r) => (
              <li
                key={r}
      ...
      <div className="text-center py-4">
        <div className="w-24 h-24 mx-auto mb-6">
          <svg viewBox="0 0 96 96" className="w-24 h-24">
            ...
            <path
              d="M 48 28 L 60 48 L 48 58 L 36 48 Z"
              fill="#EF4444"
              fillOpacity="0.15"
              stroke="#EF4444"
              strokeWidth="2"
        ...
        <p
          ...
          style={{ fontFamily: RB }}
        >
          You don't have permission to access this module. Your role may not
          include the required privileges.
        </p>
  ...
  return (
    <AuthCard>
      ...
      <div className="text-center py-4">
        <div className="mb-6">
          <svg viewBox="0 0 160 100" className="w-48 mx-auto">
            ...
            <Search
              ...
              style={{ transform: "translate(60px, 36px)" }}
            />
            <text
              x="68"
              y="49"
        ...
        <p
          className="text-sm text-[#64748B] leading-relaxed mb-7"
          style={{ fontFamily: RB }}
        >
          The page you're looking for doesn't exist or has been moved. Please
          check the URL or return to the home screen.
        </p>
      ...
      <div className="text-center py-4">
        <div className="mb-6">
          <svg viewBox="0 0 120 100" className="w-40 mx-auto">
            ...
            {/* Lightning */}
            <path
              d="M 55 73 L 50 85 L 57 85 L 52 97 L 70 79 L 62 79 L 67 67 Z"
              fill="#F59E0B"
              fillOpacity="0.3"
              stroke="#F59E0B"
              strokeWidth="1"
        ...
        <p className="text-xs text-[#64748B] mt-5" style={{ fontFamily: RB }}>
          Need help?{" "}
          <button className="text-[#0D47A1] font-medium hover:underline">
            Contact Support
          </button>
        </p>
      </div>
...
function DemoNav({
  ...
  current: AuthScreen;
  onSelect: (s: AuthScreen) => void;
}) {
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50">
      <div
        className="flex items-center gap-1 bg-white/90 border border-gray-200 rounded-2xl px-3 py-2 shadow-lg"
        style={{ backdropFilter: "blur(8px)" }}
      >
        <span
          className="text-[10px] font-semibold text-slate-400 mr-1 uppercase tracking-wide"
          style={{ fontFamily: RB }}
        >
          Demo:
        </span>
...
export default function AuthApp({
  ...
  const renderScreen = () => {
    switch (screen) {
      case "login":
        return (
          <LoginScreen onLogin={onLogin} onForgot={() => goTo("forgot")} />
        );
      case "forgot":
        return (
          <ForgotScreen
      ...
      case "reset":
        return <ResetScreen onSubmit={() => goTo("success")} />;
      case "success":
        return <SuccessScreen onLogin={() => goTo("login")} />;
      case "session-expired":
        return <SessionExpiredScreen onLogin={() => goTo("login")} />;
      case "access-denied":
        return (
          <AccessDeniedScreen
            onBack={() => goTo("login")}
      ...
      case "404":
        return <NotFoundScreen onHome={() => goTo("login")} />;
      case "500":
        return (
          <ServerErrorScreen onRetry={() => {}} onHome={() => goTo("login")} />
        );
    }
  };
