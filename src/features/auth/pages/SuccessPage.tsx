...
export const SuccessPage: React.FC<SuccessPageProps> = ({
  ...
  return (
    <div className="w-full space-y-6 text-center">
      ...
      <button
        onClick={onContinue}
        className="w-full py-3.5 px-6 bg-[#0D47A1] hover:bg-[#1565C0] text-white font-heading font-semibold text-sm rounded-xl shadow-md transition-transform active:scale-[0.99] flex items-center justify-center gap-2"
      >
