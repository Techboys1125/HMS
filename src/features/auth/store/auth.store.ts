...
import type {User, AuthTokens, AuthState}
...
export function useAuthStore<T = AuthState>(selector ?:(state: AuthState) => T,): T {
    const snapshot = useSyncExternalStore(authStoreActions.subscribe, authStoreActions.getState, authStoreActions.getState,);
