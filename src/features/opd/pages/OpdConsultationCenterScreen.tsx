      ...
      <div className="bg-white border-b border-[#E5E7EB] px-6 py-4">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() =>
                onStartConsultation?.(nextPatient?.id || currentPatient?.id)
              }
              ...
              {isLoading ? (
                ...
                <div className="py-16 px-6 text-center flex flex-col items-center justify-center">
                  ...
                  >
                    ...
                    filters. You can start a new consultation or clear filters.
                  </p>
                  <button
          ...
          <div className="lg:col-span-4 xl:col-span-3 space-y-6">
            ...
            <div className="bg-white rounded-2xl p-5 border border-[#E5E7EB] shadow-sm space-y-4">
              <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                ...
                <span
                  className="text-xs text-[#0D47A1] font-semibold"
                  style={{ fontFamily: PP }}
                >
                  OPD Wing A
                </span>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span
                    className="font-bold text-[#009688]"
                    style={{ fontFamily: PP }}
                  >
                    {nextPatient?.appointmentTime || "N/A"}
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-lg w-full p-6 space-y-5 border border-gray-100 shadow-2xl animate-in fade-in zoom-in-95">
            <div className="flex items-center justify-between border-b border-gray-100 pb-4">
              <div>
                <span className="text-[10px] font-mono text-[#0D47A1] bg-blue-50 px-2 py-0.5 rounded font-bold">
                  {selectedRecord.id}
                </span>
                <h3
              ...
              <div className="grid grid-cols-2 gap-4 p-3 bg-slate-50 rounded-xl">
                <div>
                  ...
                  <p className="text-slate-500">
                    {selectedRecord.mrn} ({selectedRecord.age}y /{" "}
          ...
          <div className="bg-white rounded-2xl max-w-md w-full p-6 space-y-5 border border-gray-100 shadow-2xl">
            ...
            <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl text-xs space-y-2 text-slate-700">
              ...
              <p className="text-slate-500 italic mt-2">
                Ready to send to connected hospital receipt printer.
              </p>
            </div>
