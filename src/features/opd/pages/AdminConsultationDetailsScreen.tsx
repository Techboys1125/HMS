    ...
    <div className="flex-1 bg-[#F1F5F9] overflow-y-auto flex flex-col font-sans relative pb-24">
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="bg-white rounded-2xl p-5 border border-[#E5E7EB] shadow-sm space-y-3">
          ...
          <div
            className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-9 gap-3 text-xs"
            style={{ fontFamily: RB }}
          >
            <div>
              <span
          ...
          <div className="lg:col-span-4 space-y-5">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div
                    ...
                    style={{ fontFamily: RB }}
                  >
                    {record.age} yrs · {record.gender} · Blood{" "}
                    {record.bloodGroup}
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl p-5 border border-[#E5E7EB] shadow-sm space-y-3">
              ...
              <div className="flex items-center gap-3 p-3 bg-slate-50 border border-slate-100 rounded-xl">
                <div
                  className="w-10 h-10 rounded-full bg-[#009688] text-white flex items-center justify-center font-bold text-xs"
                  style={{ fontFamily: PP }}
                >
                  AM
                </div>
                <div>
                  ...
                  <div className="text-[10px] text-[#0D47A1] font-semibold mt-0.5">
                    {record.department} · {record.doctorExperience}
                  </div>
                </div>
              </div>
            </div>
                ...
                {operationalTimelineEvents.map((evt, idx) => (
                  <div key={idx} className="flex gap-3">
                    <div className="flex flex-col items-center">
                      <div
                        className={`w-2.5 h-2.5 rounded-full ${idx === operationalTimelineEvents.length - 1 ? "bg-[#66BB6A]" : "bg-[#0D47A1]"} mt-1 shrink-0`}
                      />
                      {idx < operationalTimelineEvents.length - 1 && (
                    ...
                    <div className="pb-3 flex-1">
                      <div className="flex items-center justify-between">
                        ...
                        <span
                          className={`text-[10px] font-semibold px-2 py-0.5 rounded ${evt.badgeColor}`}
                          style={{ fontFamily: PP }}
                        >
                          {evt.status}
                        </span>
            ...
            <div className="bg-white rounded-2xl p-5 border border-[#E5E7EB] shadow-sm space-y-2">
              ...
              <button
                onClick={() =>
                  alert(`Printed Operational Summary for ${record.id}`)
                }
