...
import {
  Stethoscope, User, Clock, Pill, CheckCircle2,
...
const HISTORICAL_CONSULTATIONS: TimelineConsultationItem[] = [
  {
    ...
    vitals: { bp: '145/92', pulse: '88 bpm', temp: '37.2°C', spo2: '97%', bmi: '25.5 kg/m²' },
    medicines: [
      { name: 'Amlodipine', dosage: '5mg', freq: 'Once Daily', duration: '30 Days' },
      { name: 'Metformin', dosage: '500mg', freq: 'Twice Daily', duration: '30 Days' }
    ],
    investigations: ['CBC', 'ECG', '2D Echocardiogram & Trop-I STAT'],
    examinationFindings: 'Chest wall non-tender. Normal S1/S2 heart sounds. Bilateral vesicular breath sounds.',
    clinicalNotes: 'High cardiovascular risk profile. Low sodium diet & rest recommended.'
  },
  {
    id: 'CNS-0982',
    date: '12 Jun 2026',
    ...
    vitals: { bp: '138/86', pulse: '76 bpm', temp: '36.8°C', spo2: '98%', bmi: '25.7 kg/m²' },
    medicines: [
      { name: 'Amlodipine', dosage: '5mg', freq: 'Once Daily', duration: '30 Days' },
      { name: 'Aspirin', dosage: '75mg', freq: 'Once Daily', duration: '30 Days' },
      { name: 'Atorvastatin', dosage: '20mg', freq: 'Once Nightly', duration: '30 Days' }
    ],
    investigations: ['Lipid Profile'],
    examinationFindings: 'No peripheral edema. Heart sounds clear.',
    clinicalNotes: 'BP response satisfactory. Continue current anti-hypertensive regimen.'
  },
  {
    id: 'CNS-0941',
    date: '15 Apr 2026',
    ...
    followupStatus: 'Completed',
    vitals: { bp: '130/82', pulse: '82 bpm', temp: '36.6°C', spo2: '99%', bmi: '25.8 kg/m²' },
    medicines: [
      { name: 'Multivitamin Tab', dosage: '1 Tab', freq: 'Once Daily', duration: '15 Days' },
      { name: 'Magnesium Supplement', dosage: '250mg', freq: 'Once Nightly', duration: '15 Days' }
    ],
    investigations: ['Complete Blood Count (CBC)', 'Thyroid Panel (TSH)'],
    examinationFindings: 'General physical examination normal. Thyroid non-palpable.',
    clinicalNotes: 'Hydration advised. Reassure patient regarding stress-related symptoms.'
  },
  {
    id: 'CNS-0890',
    date: '08 Feb 2026',
    ...
    investigationsCount: 3,
    followupStatus: 'Completed',
    vitals: { bp: '142/90', pulse: '84 bpm', temp: '36.7°C', spo2: '98%', bmi: '26.0 kg/m²' },
    medicines: [
      { name: 'Amlodipine', dosage: '2.5mg', freq: 'Once Daily', duration: '30 Days' }
    ],
    ...
    clinicalNotes: 'Initiate dietary salt restriction and light cardio exercise.'
  }
]
...
export function ConsultationHistoryScreen({
  ...
  }, [searchQuery, filterDoctor, filterDepartment, filterVisitType, filterStatus])
  ...
  return (
    <div className="flex-1 bg-[#F1F5F9] overflow-y-auto flex flex-col font-sans relative pb-24">
          ...
          <div className="flex items-center gap-3 overflow-x-auto">
            ...
            <div>
              ...
              <div className="flex items-center gap-3 text-xs text-[#64748B] mt-0.5" style={{ fontFamily: RB }}>
                ...
                <span>•</span>
                <span>Last Visit: <strong className="text-[#111827]">24 Jul 2026</strong></span>
                <span>•</span>
                <span>Primary Doctor: <strong className="text-[#0D47A1]">Dr. Arjun Mehta</strong></span>
              </div>
            </div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          <div className="bg-white rounded-2xl p-4 border border-[#E5E7EB] shadow-sm flex flex-col justify-between">
            ...
            <div className="mt-2">
              <div className="text-2xl font-bold text-[#111827]" style={{ fontFamily: PP }}>4</div>
          ...
          <div className="bg-white rounded-2xl p-4 border border-[#E5E7EB] shadow-sm flex flex-col justify-between">
            ...
            <div className="mt-2">
              <div className="text-2xl font-bold text-[#111827]" style={{ fontFamily: PP }}>2</div>
              <div className="text-[11px] text-purple-600 font-medium mt-0.5" style={{ fontFamily: RB }}>1 Scheduled Next</div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-4 border border-[#E5E7EB] shadow-sm flex flex-col justify-between">
            ...
            <div className="mt-2">
              <div className="text-lg font-bold text-[#111827]" style={{ fontFamily: PP }}>24 Jul 2026</div>
              <div className="text-[11px] text-slate-500 mt-0.5" style={{ fontFamily: RB }}>Dr. Arjun Mehta</div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-4 border border-[#E5E7EB] shadow-sm flex flex-col justify-between">
            ...
            <div className="mt-2">
              <div className="text-2xl font-bold text-[#111827]" style={{ fontFamily: PP }}>3</div>
              <div className="text-[11px] text-slate-500 mt-0.5" style={{ fontFamily: RB }}>Amlodipine, Metformin</div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                        ...
                        {isExpanded && (
                          <div className="p-5 space-y-5 bg-white border-t border-gray-100 text-xs" style={{ fontFamily: RB }}>
                            ...
                            <div className="pt-3 border-t border-gray-100 flex items-center justify-end gap-2">
                              <button
                                onClick={() => alert(`Prescription printed for ${item.id}`)}
          ...
          <div className="lg:col-span-4 space-y-5">
            ...
            <div className="bg-white rounded-2xl p-5 border border-[#E5E7EB] shadow-sm space-y-4">
              ...
              <div className="space-y-2 text-xs pt-2 border-t border-gray-100" style={{ fontFamily: RB }}>
                <div className="flex justify-between text-slate-600">
                  ...
                  <span className="font-bold text-slate-800">Hypertension Stage 1</span>
                </div>
                <div className="flex justify-between text-slate-600">
            ...
            <div className="bg-white rounded-2xl p-5 border border-[#E5E7EB] shadow-sm space-y-3">
              <h3 className="text-sm font-bold text-[#111827]" style={{ fontFamily: PP }}>Consultation Statistics</h3>

              <div className="space-y-2 text-xs" style={{ fontFamily: RB }}>
                <div className="flex justify-between py-1 border-b border-gray-50">
                  <span className="text-slate-500">Total Visits:</span>
                  <span className="font-bold text-[#111827]" style={{ fontFamily: PP }}>4 Visits</span>
                </div>
                <div className="flex justify-between py-1 border-b border-gray-50">
                  <span className="text-slate-500">Completed Consultations:</span>
                  <span className="font-bold text-[#66BB6A]" style={{ fontFamily: PP }}>4 Completed</span>
                </div>
                <div className="flex justify-between py-1 border-b border-gray-50">
                  <span className="text-slate-500">Follow-up Visits:</span>
                  <span className="font-bold text-purple-600" style={{ fontFamily: PP }}>2 Visits</span>
                </div>
                <div className="flex justify-between py-1">
                  <span className="text-slate-500">Avg Consultation Interval:</span>
                  <span className="font-bold text-[#0D47A1]" style={{ fontFamily: PP }}>28 Days</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-5 border border-[#E5E7EB] shadow-sm space-y-3">
              <h3 className="text-sm font-bold text-[#111827]" style={{ fontFamily: PP }}>Recent Diagnoses</h3>

              <div className="space-y-2 text-xs" style={{ fontFamily: RB }}>
                {[
                  { dx: 'Angina Pectoris, unspecified', date: '24 Jul 2026', icd: 'I20.9' },
                  { dx: 'Essential (primary) Hypertension', date: '12 Jun 2026', icd: 'I10' },
                  { dx: 'Fatigue & Malaise, unspecified', date: '15 Apr 2026', icd: 'R53.83' },
                  { dx: 'Borderline Hypertension & Hyperlipidemia', date: '08 Feb 2026', icd: 'I10 / E78.5' },
                ].map((item, idx) => (
                  <div key={idx} className="p-2.5 bg-slate-50 rounded-xl space-y-0.5 border border-slate-100">
                    <div className="font-bold text-slate-800" style={{ fontFamily: PP }}>{item.dx}</div>
            ...
            <div className="bg-white rounded-2xl p-5 border border-[#E5E7EB] shadow-sm space-y-3">
              ...
              <div className="space-y-2 text-xs" style={{ fontFamily: RB }}>
                {[
                  { med: 'Amlodipine 5mg', freq: 'Once Daily', date: '24 Jul 2026' },
                  { med: 'Metformin 500mg', freq: 'Twice Daily', date: '24 Jul 2026' },
                  { med: 'Aspirin 75mg', freq: 'Once Daily', date: '12 Jun 2026' },
                  { med: 'Atorvastatin 20mg', freq: 'Once Nightly', date: '12 Jun 2026' },
                ].map((m, idx) => (
                  <div key={idx} className="flex items-center justify-between p-2 bg-blue-50/50 rounded-lg text-xs">
                    <div>
                      <div className="font-bold text-slate-800" style={{ fontFamily: PP }}>{m.med}</div>
                      <div className="text-[10px] text-slate-500">{m.freq}</div>
                    </div>
                    <span className="text-[10px] text-[#0D47A1] font-mono">{m.date}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-5 border border-[#E5E7EB] shadow-sm space-y-2">
              ...
              {role === 'doctor' && (
                <>
                  ...
                  <button
                    onClick={() => alert(`Medical history document printed for Sarah Mitchell`)}
                    className="w-full py-2.5 px-4 bg-teal-50 hover:bg-teal-100 text-[#009688] text-xs font-semibold rounded-xl transition-colors flex items-center justify-center gap-2"
                    style={{ fontFamily: PP }}
                  >
                    <Printer size={15} />
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-[#E5E7EB] px-6 py-3 shadow-lg flex items-center justify-between">
        <div className="text-xs text-[#64748B]" style={{ fontFamily: RB }}>
          Consultation History for <strong className="text-[#111827]">Sarah Mitchell</strong> (MRN-2024-001)
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={() => alert(`Exporting Consultation History PDF for Sarah Mitchell`)}
