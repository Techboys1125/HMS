...
export function EditConsultationScreen({
  ...
  const [formData, setFormData] = useState({
    ...
    revisionReason:
      "Updated clinical advice & adjusted anti-hypertensive dosage instructions per patient query.",
  });
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="bg-white rounded-2xl p-5 border border-[#E5E7EB] shadow-sm space-y-3">
          <div className="flex items-center justify-between border-b border-gray-100 pb-3">
            ...
            <span
              className="text-[10px] font-bold px-2 py-0.5 bg-blue-50 text-[#0D47A1] rounded"
              style={{ fontFamily: PP }}
            >
              Revision #{formData.revisionNumber}
            </span>
          ...
          <div
            className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-3 text-xs"
            style={{ fontFamily: RB }}
          >
            <div>
              <span
              ...
              <p className="font-mono font-bold text-[#0D47A1]">
                {formData.consultationId}
              </p>
            </div>
            <div>
