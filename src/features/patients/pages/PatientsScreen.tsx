            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-blue-200" style={{ fontFamily: RB }}>
                  UHID: {patient?.id || "PT-2024-001"} • Demographic &amp;
                  Contact Update
                </p>
              </div>
            </div>
...
function ProfileBookApptDrawer({
  isOpen,
  onClose,
  patientName,
  onSuccess,
...
function ProfileApptDetailsDrawer({
  appt,
  onClose,
  onAction,
}: {
...
function ProfileVisitDetailsDrawer({
  visit,
  onClose,
  onPrint,
}: {
              ...
              {recentRegistrations.map((item, idx) => (
                ...
                >
                  <div>
                    ...
                    <div className="text-[10px] font-mono text-[#0D47A1]">
                      {item.uhid}
                    </div>
                  </div>
...
export function PatientSearchScreen({
  ...
  const selectedPatient =
    patients.find((p) => p.uhid === selectedPatientId) || filteredPatients[0];
          ...
          <button
            onClick={() =>
              onBookAppointmentClick && selectedPatient
                ? onBookAppointmentClick(selectedPatient.uhid)
                : null
            }
                        ...
                        >
                          ...
                          >
                            <div className="flex items-center justify-end gap-1.5">
                              <button
                                onClick={() =>
                                  onPatientSelect && onPatientSelect(p.uhid)
                                }
                              ...
                              {p.status === "Scheduled" && (
                                <button
                                  onClick={() =>
                                    onCheckInClick && onCheckInClick(p.uhid)
                                  }
          ...
          {selectedPatient ? (
            <>
              ...
              <div className="bg-white rounded-2xl border border-[#E5E7EB] p-5 shadow-sm space-y-2.5">
                ...
                <button
                  onClick={() =>
                    onPatientSelect && onPatientSelect(selectedPatient.uhid)
                  }
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-2 shrink-0">
            ...
            <button
              onClick={() =>
                alert(
                  `Printing official Patient Card for ${patient.name} (${patient.uhid})...`,
                )
              }
              className="px-3 py-2 rounded-xl border border-gray-200 bg-white text-xs font-semibold text-slate-700 hover:bg-slate-50 transition-colors flex items-center gap-1.5"
            >
                          ...
                          >
                            ...
                            <td className="px-3 py-3 text-right">
                              {item.status === "Scheduled" ? (
                                <button
                                  onClick={() =>
                                    onCheckInClick?.(item.id, patient.uhid)
                                  }
          ...
          <div className="bg-white rounded-2xl max-w-lg w-full p-6 space-y-4 shadow-2xl animate-in zoom-in-95 duration-150">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div>
                  <strong>UHID:</strong> {rxRecord.uhid}
                </div>
                <div>
