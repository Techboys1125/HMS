...
const appointmentToPatientSummary = (
...
function StatusBadge({ status }: { status: AppointmentStatus | string }) {
  const c =
    STATUS_CONFIG[status as AppointmentStatus] || STATUS_CONFIG["Scheduled"];
  return (
    <span
      ...
      if (initialUhid) {
        return (
          PATIENT_DATABASE.find(
            (p) =>
              (p.mrn || "").toLowerCase() === initialUhid.toLowerCase() ||
              String(p.id).toLowerCase() === initialUhid.toLowerCase(),
          ) || PATIENT_DATABASE[0]
        );
      }
              ...
              <div className="bg-white rounded-2xl border border-[#E5E7EB] p-5 shadow-sm space-y-4">
                <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                  ...
                  {onViewPatientProfileClick && (
                    <button
                      onClick={() =>
                        onViewPatientProfileClick(selectedApt.uhid)
                      }
                        ...
                        >
                          ...
                          >
                            <div className="flex items-center justify-end gap-1.5">
                              ...
                              <button
                                onClick={() =>
                                  onPatientSelect && onPatientSelect(item.uhid)
                                }
                                title="View Patient"
