        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100">
          ...
          <div className="p-6 space-y-5">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-slate-500 font-mono mt-0.5">
                      <span className="text-[#0D47A1] font-bold">{patientInfo.mrn}</span> · ID: {patientInfo.id}
                    </div>
                  </div>
                </div>
            ...
            {(activeTab === "all" || activeTab === "appointment") && (
              <div className="bg-white p-5 rounded-2xl border border-[#E5E7EB] shadow-sm space-y-4">
                <h3 className="text-xs font-bold text-[#111827] uppercase tracking-wider border-b border-gray-100 pb-3 flex items-center gap-2" style={{ fontFamily: PP }}>
                  <Calendar size={15} className="text-[#0D47A1]" /> Appointment Information
                </h3>
            ...
            {(activeTab === "all" || activeTab === "clinical") && (
              <div className="bg-white p-5 rounded-2xl border border-[#E5E7EB] shadow-sm space-y-4">
                ...
                <div className="space-y-2 text-xs">
                  <div>
                    <span className="text-slate-400 text-[10px] block font-medium mb-1">Chief Complaint</span>
            ...
            {(activeTab === "all" || activeTab === "alerts") && (
              <div className="bg-white p-5 rounded-2xl border border-[#E5E7EB] shadow-sm space-y-4">
                <h3 className="text-xs font-bold text-[#111827] uppercase tracking-wider border-b border-gray-100 pb-3 flex items-center gap-2" style={{ fontFamily: PP }}>
                  <AlertTriangle size={15} className="text-[#EF4444]" /> Patient Alerts
                </h3>
                <div className="p-3.5 bg-amber-50 border border-amber-200 rounded-xl flex items-start gap-3">
                  <AlertTriangle size={16} className="text-[#F59E0B] mt-0.5 shrink-0" />
                  <div>
                    <div className="text-xs font-bold text-amber-900" style={{ fontFamily: PP }}>Patient Alerts</div>
                    <div className="text-xs text-amber-800 mt-0.5 font-medium">
                      Review patient medical history and allergies before consultation.
                    </div>
                  </div>
                </div>
              </div>
