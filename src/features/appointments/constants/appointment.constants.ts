import type { PatientSummary, DoctorSummary, AppointmentRecord } from "../types/appointment.types";

export const PP = "Poppins, sans-serif";
export const RB = "Roboto, sans-serif";

export type ChipVariant = "success" | "warning" | "error" | "info" | "teal" | "default";

export const PATIENT_DATABASE: PatientSummary[] = [];
export const DOCTOR_DATABASE: Record<string, DoctorSummary> = {};
export const DOCTOR_AVAILABILITY_DATA: Record<string, { specialty: string; department: string; opdRoom: string; slotDuration: string; slots: { time: string; available: boolean }[] }> = {};
...
export const STATUS_CONFIG: Record<AppointmentStatus, { bg: string; text: string; dot: string; border: string }> = {
