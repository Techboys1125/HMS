...
import { SeverityBadgeLarge, StatusBadgeLarge } from "../components/AuditBadges";
...
export function AuditLogDetailsPage({
  ...
  const { data: record, isLoading } = useAuditLogDetail(recordId);
    ...
    return (
      <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-[#F1F5F9]" style={{ fontFamily: RB }}>
        <div className="py-16 text-center space-y-4">
          ...
          <div>
            <h3 className="text-base font-bold text-gray-800" style={{ fontFamily: PP }}>Loading Audit Log Details...</h3>
            <p className="text-xs text-gray-500 mt-1">Fetching audit record {recordId}.</p>
          </div>
        </div>
      </div>
    );
    ...
    return (
      <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-[#F1F5F9]" style={{ fontFamily: RB }}>
        <div className="py-16 text-center space-y-4">
          ...
          <div>
            <h3 className="text-base font-bold text-gray-800" style={{ fontFamily: PP }}>Audit Record Not Found</h3>
            <p className="text-xs text-gray-500 mt-1">The audit record {recordId} could not be found.</p>
          </div>
          <button onClick={onBack} className="inline-flex items-center gap-2 px-4 py-2 text-xs font-semibold text-white rounded-lg" style={{ backgroundColor: "#0D47A1" }}>
  ...
  return (
    <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-[#F1F5F9]" style={{ fontFamily: RB }}>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <div className="flex items-center gap-3">
              <button onClick={onBack} className="p-2 rounded-xl bg-gray-100 hover:bg-gray-200 text-gray-700 transition-colors" title="Back to Audit Logs">
                <ArrowLeft className="w-5 h-5" />
              </button>
              <div>
                <div className="flex items-center gap-3">
                  <h1 className="text-2xl font-bold text-gray-900" style={{ fontFamily: PP }}>Audit Log Details</h1>
                  <span className="px-3 py-1 bg-blue-50 text-blue-900 font-mono font-bold rounded-lg border border-blue-200 text-xs">{record.id}</span>
                </div>
                <p className="text-sm text-gray-500 mt-1">Complete audit trail and event information for administrative verification.</p>
              </div>
            </div>
          </div>
          <div className="flex flex-wrap items-center gap-2.5">
            <button onClick={onBack} className="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors shadow-sm">
              <ArrowLeft className="w-4 h-4" />
              Back to Audit Logs
            </button>
            <button onClick={() => showToast("Printing audit log details...")} className="inline-flex items-center gap-2 px-3.5 py-2 text-sm font-semibold text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors shadow-sm">
              <Printer className="w-4 h-4 text-gray-600" />
              Print
            </button>
            <button onClick={() => showToast("Exporting Audit Details PDF...")} className="inline-flex items-center gap-2 px-3.5 py-2 text-sm font-semibold text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors shadow-sm">
              <FileText className="w-4 h-4 text-red-600" />
              Export PDF
            </button>
            <button onClick={() => showToast("Exporting JSON raw payload...")} className="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white rounded-lg transition-colors shadow-sm" style={{ backgroundColor: "#0D47A1" }}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-4">
            <div className="flex items-center justify-between border-b border-gray-100 pb-3">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-base font-bold text-gray-900" style={{ fontFamily: PP }}>Section 1: Audit Event Summary</h2>
              </div>
              <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="p-3 bg-blue-50 text-blue-950 font-bold rounded-xl border border-blue-100 text-sm">{record.action}</div>
            </div>
            <div>
              <span className="text-gray-400 text-[10px] uppercase font-bold block mb-1">Full Event Description</span>
              <p className="p-3.5 bg-gray-50 text-gray-800 text-xs rounded-xl leading-relaxed border border-gray-200">{record.description}</p>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-4">
            <div className="flex items-center gap-2 border-b border-gray-100 pb-3">
              ...
              <h2 className="text-base font-bold text-gray-900" style={{ fontFamily: PP }}>Section 2: User Information</h2>
            </div>
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-4 bg-slate-50 rounded-xl border border-gray-200">
              ...
              <div className="flex-1 space-y-1 text-xs">
                <div className="flex items-center gap-2">
                  ...
                  <span className="px-2 py-0.5 bg-blue-100 text-blue-900 rounded font-semibold text-[11px]">{record.userRole}</span>
                </div>
              ...
              <div className="text-right text-xs">
                <span className="px-2.5 py-1 bg-emerald-100 text-emerald-800 font-bold rounded-full text-[11px] block">Status: Active</span>
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-4">
            <div className="flex items-center gap-2 border-b border-gray-100 pb-3">
              ...
              <h2 className="text-base font-bold text-gray-900" style={{ fontFamily: PP }}>Section 3: Activity Information</h2>
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 text-xs bg-gray-50 p-4 rounded-xl border border-gray-200">
              <div>
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-4">
            <div className="flex items-center gap-2 border-b border-gray-100 pb-3">
              ...
              <h2 className="text-base font-bold text-gray-900" style={{ fontFamily: PP }}>Section 4: Audit Timeline</h2>
            </div>
            <div className="relative pl-6 space-y-6 before:absolute before:left-2.5 before:top-2 before:bottom-2 before:w-0.5 before:bg-gray-200">
              {[
                { title: "Event Generated", time: record.timestamp, desc: `Audit trigger initialized for action: ${record.action}`, status: "Completed" },
                { title: "User Authenticated", time: record.timestamp, desc: `Token validated for ${record.user} (${record.userRole})`, status: "Completed" },
                { title: "Screen Opened", time: record.timestamp, desc: `User navigated to ${record.module} Workspace`, status: "Completed" },
                { title: "Action Executed", time: record.timestamp, desc: record.description, status: "Completed" },
                { title: "Database Updated", time: record.timestamp, desc: `Database transaction committed for record ${record.recordId || record.id}`, status: "Completed" },
                { title: "Audit Recorded", time: record.timestamp, desc: `Immutable audit record ${record.id} written to vault log stream`, status: "Completed" },
                { title: "Notification Triggered", time: record.timestamp, desc: "Real-time websocket audit notification dispatched to Admin dashboard", status: "Completed" },
              ].map((step, idx) => (
          ...
          {record.category === "Data Changes" && record.fieldChanged && (
            <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-4">
              <div className="flex items-center gap-2 border-b border-gray-100 pb-3">
                ...
                <h2 className="text-base font-bold text-gray-900" style={{ fontFamily: PP }}>Section 5: Data Comparison (Field Modifications)</h2>
              </div>
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="p-4 bg-red-50 rounded-xl border border-red-200">
                    ...
                    <div className="font-mono text-xs text-red-900 font-bold bg-white p-3 rounded-lg border border-red-200">{record.oldValue || "N/A"}</div>
                  </div>
                  <div className="p-4 bg-emerald-50 rounded-xl border border-emerald-200">
                    <span className="text-xs font-bold text-emerald-700 block mb-1">Updated Value (After)</span>
                    <div className="font-mono text-xs text-emerald-900 font-bold bg-white p-3 rounded-lg border border-emerald-200">{record.newValue || "N/A"}</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-4">
            <div className="flex items-center gap-2 border-b border-gray-100 pb-3">
              ...
              <h2 className="text-base font-bold text-gray-900" style={{ fontFamily: PP }}>Section 6: Related Records</h2>
            </div>
            <div className="flex flex-wrap gap-2">
              {[
                { label: `Record: ${record.recordId || record.id}`, type: "Record" },
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-4">
            <div className="flex items-center gap-2 border-b border-gray-100 pb-3">
              ...
              <h2 className="text-base font-bold text-gray-900" style={{ fontFamily: PP }}>Section 7: Technical Information</h2>
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs bg-gray-50 p-4 rounded-xl border border-gray-200">
              ...
              <div>
                ...
                <span className="font-mono text-gray-700 text-xs mt-0.5 block">{record.sessionDuration || "Active"}</span>
              </div>
              <div>
        ...
        <div className="lg:col-span-4 space-y-4 sticky top-6">
          ...
          <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm space-y-3">
            <h4 className="text-sm font-bold text-gray-900 border-b border-gray-100 pb-2" style={{ fontFamily: PP }}>Audit Summary</h4>
            <div className="space-y-2 text-xs font-medium">
              ...
              <div className="flex justify-between py-1 border-b border-gray-100">
                ...
                <span><SeverityBadgeLarge severity={record.severity} /></span>
              </div>
              <div className="flex justify-between py-1 border-b border-gray-100">
                <span className="text-gray-500">Status</span>
                <span><StatusBadgeLarge status={record.status} /></span>
              </div>
              <div className="flex justify-between py-1 border-b border-gray-100">
          ...
          {/* Risk Assessment */}
          <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm space-y-3">
            <h4 className="text-sm font-bold text-gray-900 border-b border-gray-100 pb-2" style={{ fontFamily: PP }}>Risk Assessment</h4>
            <div className="flex items-center gap-4">
              <div className="relative flex items-center justify-center">
                <svg className="w-16 h-16 transform -rotate-90" viewBox="0 0 36 36">
                  <circle cx="18" cy="18" r="14" fill="none" stroke="#F1F5F9" strokeWidth="3" />
                  <circle cx="18" cy="18" r="14" fill="none" stroke={record.severity === "Critical" ? "#EF4444" : "#66BB6A"} strokeWidth="3" strokeDasharray={record.severity === "Critical" ? "30 100" : "95 100"} />
                </svg>
                <div className="absolute text-center">
                  <span className="text-xs font-bold text-gray-900">{record.severity === "Critical" ? "High" : "Low"}</span>
                </div>
              </div>
          ...
          {/* Quick Navigation */}
          <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm space-y-3">
            <h4 className="text-sm font-bold text-gray-900 border-b border-gray-100 pb-2" style={{ fontFamily: PP }}>Quick Navigation</h4>
            <div className="space-y-2 text-xs">
              <button onClick={onBack} className="w-full text-left px-3 py-2 bg-blue-50 text-blue-900 font-semibold rounded-xl hover:bg-blue-100 transition-colors flex items-center justify-between">
                <span>Back to Audit Logs</span>
                <ChevronRight className="w-4 h-4" />
              </button>
              {(["Login History", "User Activities", "Data Changes", "Deleted Records", "System Logs"] as AuditCategory[]).map((cat) => (
                <button
                  key={cat}
                  onClick={() => { if (onNavigateCategory) onNavigateCategory(cat); onBack(); }}
          ...
          <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm space-y-3">
            <h4 className="text-sm font-bold text-gray-900 border-b border-gray-100 pb-2 flex items-center justify-between" style={{ fontFamily: PP }}>
              ...
              <span className="px-2 py-0.5 bg-emerald-100 text-emerald-800 text-[10px] font-bold rounded-full">Verified</span>
            </h4>
            <div className="space-y-2 text-xs">
      ...
      <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-4">
        <div className="flex items-center justify-between border-b border-gray-100 pb-3">
          <div>
            <h3 className="text-base font-bold text-gray-900" style={{ fontFamily: PP }}>Bottom Panel: Related Audit Events</h3>
            <p className="text-xs text-gray-500 mt-0.5">Latest related audit records from the system log stream.</p>
          </div>
          <span className="text-xs font-bold text-blue-900 bg-blue-50 px-3 py-1 rounded-full border border-blue-200">{relatedAuditLogs.length} Related Records</span>
        </div>
            ...
            <tbody className="divide-y divide-gray-200 bg-white font-medium text-gray-800">
              {relatedAuditLogs.map((log) => (
                <tr key={log.id} className="hover:bg-blue-50/40 transition-colors">
                  <td className="p-3.5 font-mono text-gray-500">{log.timestamp}</td>
                  <td className="p-3.5">
                    <span className="px-2 py-0.5 rounded bg-gray-100 font-medium text-gray-700">{log.module}</span>
                  </td>
                  <td className="p-3.5 font-semibold text-blue-950">{log.action}</td>
                  <td className="p-3.5 font-bold text-gray-900">{log.user}</td>
                  <td className="p-3.5"><SeverityBadgeLarge severity={log.severity} /></td>
                  <td className="p-3.5"><StatusBadgeLarge status={log.status} /></td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <div className="sticky bottom-0 z-30 bg-white/95 backdrop-blur border-t border-gray-200 px-6 py-3 rounded-2xl shadow-lg flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="text-xs font-semibold text-gray-700">
          Audit Record <span className="text-blue-900 font-bold">{record.id}</span>
        </div>
        <div className="flex items-center gap-2">
          <button onClick={onBack} className="px-4 py-1.5 text-xs font-semibold text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors">Back</button>
          <button onClick={() => showToast("Printing audit details workspace...")} className="px-3.5 py-1.5 text-xs font-semibold text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors">Print</button>
          <button onClick={() => showToast("Exporting Audit Details...")} className="px-4 py-1.5 text-xs font-semibold text-white rounded-lg transition-colors shadow-sm" style={{ backgroundColor: "#0D47A1" }}>Export</button>
        </div>
      </div>
    </div>
  );
