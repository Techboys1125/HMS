import {
  Receipt, CreditCard, Download, BarChart2, Bell, DollarSign, Clock, Check, TrendingUp
} from 'lucide-react'
import { BarChart, Bar, Cell, ResponsiveContainer, XAxis, YAxis, Tooltip } from 'recharts'
import {
  DKpi, Av, Chip, SH, ProgressBar, PP, RB
              ...
              {ACC_PAYMENT_METHODS.map(m => (
                <div key={m.method}>
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="font-mono text-xs font-[#111827] font-semibold">${(m.amount / 1000).toFixed(1)}K</span>
