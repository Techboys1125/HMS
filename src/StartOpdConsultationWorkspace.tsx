    ...
    <div className="flex-1 bg-[#F1F5F9] overflow-y-auto flex flex-col font-sans relative pb-24">
      ...
      {showToast && (
        <div className="fixed top-5 right-5 z-50 bg-[#66BB6A] text-white px-5 py-3.5 rounded-2xl shadow-xl flex items-center gap-3 animate-in fade-in slide-in-from-top-4" style={{ fontFamily: PP }}>
          ...
          <div>
            ...
            <div className="text-xs opacity-90 font-sans" style={{ fontFamily: RB }}>Clinical record has been finalized & prescription stored.</div>
          </div>
        </div>
      )}
      ...
      {isDraftSaved && (
        <div className="fixed top-5 right-5 z-50 bg-[#0D47A1] text-white px-5 py-3 rounded-2xl shadow-xl flex items-center gap-3 animate-in fade-in slide-in-from-top-4" style={{ fontFamily: PP }}>
          <Save size={18} />
          <div className="text-xs font-semibold">Consultation draft saved locally.</div>
        </div>
      )}
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 text-xs text-[#64748B] mb-1" style={{ fontFamily: RB }}>
              ...
              <ChevronRight size={12} className="text-slate-400" />
              <span className="font-semibold text-[#0D47A1]">Start Consultation</span>
            </div>
          ...
          <div className="flex items-center gap-3 overflow-x-auto">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 rounded-full text-[10px] font-semibold bg-teal-50 text-[#009688] border border-teal-200" style={{ fontFamily: PP }}>
                  In Progress
                </span>
              </div>
              <div className="flex items-center gap-3 text-xs text-[#64748B] mt-0.5" style={{ fontFamily: RB }}>
                ...
                <span>•</span>
                <span>Token: <strong className="text-[#0D47A1]">TK-01</strong></span>
                <span>•</span>
                <span>Appt: <strong className="text-[#111827]">09:00 AM</strong></span>
              </div>
            </div>
        ...
        {validationErrors.length > 0 && (
          <div className="p-4 bg-red-50 border border-red-200 rounded-2xl space-y-1">
            <div className="flex items-center gap-2 text-xs font-bold text-red-700" style={{ fontFamily: PP }}>
              <AlertCircle size={16} />
              Please resolve the following required fields before completing consultation:
            </div>
            ...
            <div className="bg-white rounded-2xl border border-[#E5E7EB] shadow-sm overflow-hidden">
              ...
              {!collapsedSections.visitInfo && (
                <div className="p-5 space-y-4">
                  ...
                  <div>
                    <label className="block text-[11px] font-semibold text-[#64748B] mb-1 flex items-center justify-between" style={{ fontFamily: PP }}>
                      <span>Chief Complaint <span className="text-red-500">*</span></span>
                      <span className="text-[10px] text-slate-400 font-normal">Primary reason for visit</span>
                    </label>
                    <textarea
                      rows={2}
              ...
              {!collapsedSections.vitals && (
                <div className="p-5 space-y-4">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 text-xs">
                    ...
                    <div>
                      <label className="block text-[11px] font-semibold text-[#64748B] mb-1" style={{ fontFamily: PP }}>Pulse (bpm)</label>
                      <input
                        type="number"
              ...
              {!collapsedSections.investigation && (
                <div className="p-5 space-y-4 text-xs" style={{ fontFamily: RB }}>
                  ...
                  <div className="p-3 bg-amber-50/60 border border-amber-100 rounded-xl flex items-start gap-2 text-[11px] text-amber-800">
                    ...
                    <span><strong>Note:</strong> These entries are clinical recommendations for patient guidance only. They do not automatically trigger lab orders.</span>
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="bg-white rounded-2xl border border-[#E5E7EB] shadow-sm p-5 space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs" style={{ fontFamily: RB }}>
                ...
                <div>
                  ...
                  <p className="font-bold text-[#0D47A1]">{formData.finalDiagnosis || 'Not specified'}</p>
                  <p className="text-[11px] text-slate-500">ICD: {formData.icdCode}</p>
                </div>
                <div>
              ...
              <div className="pt-3 border-t border-gray-100 flex flex-wrap items-center justify-between text-xs gap-3">
                <div className="flex items-center gap-4">
                  <span>Follow-up Date: <strong className="text-[#111827]">{formData.followupRequired ? formData.nextVisitDate : 'None'}</strong></span>
                  <span>Consultation Fee: <strong className="text-[#0D47A1]">$150.00</strong></span>
                </div>
                <span className="px-3 py-1 bg-teal-50 text-[#009688] border border-teal-200 rounded-full font-bold text-[11px]" style={{ fontFamily: PP }}>
                  Status: In Progress
                </span>
              </div>
            </div>
          ...
          <div className="lg:col-span-4 space-y-5">
            ...
            <div className="bg-white rounded-2xl p-5 border border-[#E5E7EB] shadow-sm space-y-4">
              <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                ...
                <span className="text-[10px] font-bold text-[#0D47A1] bg-blue-50 px-2 py-0.5 rounded">Active Visit</span>
              </div>
            ...
            <div className="bg-white rounded-2xl p-5 border border-[#E5E7EB] shadow-sm space-y-3">
              <h3 className="text-sm font-bold text-[#111827]" style={{ fontFamily: PP }}>Previous Clinical Summary</h3>
              ...
              <div className="p-3 bg-slate-50 border border-slate-100 rounded-xl space-y-1.5 text-xs" style={{ fontFamily: RB }}>
                ...
                <div className="text-slate-600">Diagnosis: Hypertensive Emergency (Controlled)</div>
            ...
            <div className="bg-white rounded-2xl p-5 border border-[#E5E7EB] shadow-sm space-y-3">
              <h3 className="text-sm font-bold text-[#111827]" style={{ fontFamily: PP }}>Consultation Progress</h3>

              <div className="space-y-3 text-xs pt-1" style={{ fontFamily: RB }}>
                {[
                  { label: 'Patient Checked-In', done: true },
                  { label: 'Vitals Recorded', done: true },
                  { label: 'Diagnosis Completed', done: !!formData.finalDiagnosis },
                  { label: 'Prescription Added', done: formData.medicines.length > 0 },
                  { label: 'Follow-up Added', done: formData.followupRequired },
                  { label: 'Consultation Completed', done: false },
                ].map((step, idx) => (
                  <div key={idx} className="flex items-center gap-2.5">
                    <div className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold ${step.done ? 'bg-[#009688] text-white' : 'bg-slate-200 text-slate-500'
                      }`}>
                      {step.done ? <Check size={12} /> : idx + 1}
                    </div>
                    <span className={`font-medium ${step.done ? 'text-[#111827]' : 'text-slate-400'}`}>
                      {step.label}
                    </span>
                  </div>
                ))}
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-[#E5E7EB] px-6 py-3 shadow-lg flex items-center justify-between">
        <div className="text-xs text-[#64748B]" style={{ fontFamily: RB }}>
          Consultation for <strong className="text-[#111827]">Sarah Mitchell</strong> (MRN-2024-001)
        </div>
