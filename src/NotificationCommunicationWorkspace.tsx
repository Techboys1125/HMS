      ...
      >
        ...
        >
          <div>
            ...
            >
              Configure system-wide notification delivery channels,
              communication preferences, reminder templates, and alert rules.
            </p>
          </div>
              ...
              <select
                ...
                onChange={(e) =>
                  setReminderConfig((prev) => ({
                    ...prev,
                    appointmentReminderTime: e.target.value,
                  }))
                }
                style={{
                  width: "100%",
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setReminderConfig((prev) => ({
                    ...prev,
                    billingReminderTime: e.target.value,
                  }))
                }
                style={{
                  width: "100%",
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setReminderConfig((prev) => ({
                    ...prev,
                    followupReminderTime: e.target.value,
                  }))
                }
                style={{
                  width: "100%",
        ...
        >
          ...
          >
            <BarChart2 size={18} style={{ color: "#0D47A1" }} /> Delivery
            Channel Volume & Success Rate
          </h3>
          ...
          >
            ...
            >
              <div>
                ...
                >
                  Category: <strong>{selectedTemplate.category}</strong> •
              ...
              >
                ...
                >
                  <Edit2 size={14} />{" "}
                  {isTemplateEditMode ? "Cancel Edit" : "Edit"}
                </button>
                <button
                  onClick={() => {
            ...
            >
              ...
              >
                ...
                <p style={{ margin: "0 0 8px 0" }}>
                  This is an automated reminder that your OPD Cardiology
                  appointment with <strong>Dr. Arjun Mehta</strong> is scheduled
                  for <strong>Tomorrow at 09:30 AM</strong>.
                </p>
