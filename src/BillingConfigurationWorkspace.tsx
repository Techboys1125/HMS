    ...
    >
      ...
      >
            ...
            {[
              ...
              >
                <input
                  type="checkbox"
                  checked={
                    (receiptConfig as unknown as Record<string, boolean>)[
                      item.key
                    ]
                  }
                  onChange={(e) =>
            ...
            {[
              ...
              >
                ...
                <input
                  type="checkbox"
                  checked={
                    (billingRules as unknown as Record<string, boolean>)[
                      item.key
                    ]
                  }
                  onChange={(e) =>
        ...
        >
          ...
          >
            <BarChart2 size={18} style={{ color: "#0D47A1" }} /> Financial
          ...
          >
            ...
            >
              ...
              >
                <PieChartIcon size={14} style={{ color: "#009688" }} /> Invoices
                by Payment Method
              </h4>
              <div
                style={{
              ...
              >
                <div
                  style={{
                    ...
                    borderRadius: "50%",
                    background:
                      "conic-gradient(#0D47A1 0% 45%, #009688 45% 75%, #F59E0B 75% 90%, #9C27B0 90% 100%)",
                  }}
                />
                <div
                  style={{
        ...
        >
          ...
          >
            <Eye size={18} style={{ color: "#0D47A1" }} /> Section 08: Billing &
            ...
            >
              ...
              >
                <div>
                  ...
                  <div style={{ fontSize: "10px", color: "#64748B" }}>
                    777 Healthcare Blvd, Medical District
                  </div>
                </div>
