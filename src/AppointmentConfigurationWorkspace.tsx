...
export function AppointmentConfigurationWorkspace() {
  ...
  const handleAddHoliday = () => {
    ...
    setHolidays(prev => [
      ...prev,
      { id: Date.now().toString(), name: newHolidayName, date: newHolidayDate, type: 'Hospital Closed' },
    ])
    setNewHolidayName('')
    setNewHolidayDate('')
  }
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', width: '100%' }}>
        ...
        <div style={{ background: '#FFFFFF', borderRadius: '16px', border: '1px solid #E5E7EB', padding: '16px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
          <div>
            ...
            <p style={{ fontSize: '12px', color: '#64748B', margin: '2px 0 0 0' }}>
              Configure hospital-wide appointment booking rules, consultation schedules, queue management and operational preferences.
            </p>
          </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px' }}>
          <div style={{ background: '#FFFFFF', borderRadius: '16px', border: '1px solid #E5E7EB', padding: '18px', boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px' }}>
              <span style={{ fontSize: '12px', fontWeight: 600, color: '#64748B' }}>Appointment Slots</span>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '6px' }}>
              <span style={{ fontSize: '11px', color: '#94A3B8' }}>Default Duration</span>
          ...
          <div style={{ background: '#FFFFFF', borderRadius: '16px', border: '1px solid #E5E7EB', padding: '18px', boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px' }}>
              <span style={{ fontSize: '12px', fontWeight: 600, color: '#64748B' }}>Working Shifts</span>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '6px' }}>
              <span style={{ fontSize: '11px', color: '#94A3B8' }}>OPD Schedule</span>
          ...
          <div style={{ background: '#FFFFFF', borderRadius: '16px', border: '1px solid #E5E7EB', padding: '18px', boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px' }}>
              <span style={{ fontSize: '12px', fontWeight: 600, color: '#64748B' }}>Queue Rules</span>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '6px' }}>
              <span style={{ fontSize: '11px', color: '#94A3B8' }}>Prefix OPD-</span>
              <span style={{ fontSize: '10px', fontWeight: 600, color: '#2E7D32', background: '#E8F5E9', padding: '1px 6px', borderRadius: '4px' }}>
                Enabled
              </span>
            </div>
          ...
          <div style={{ background: '#FFFFFF', borderRadius: '16px', border: '1px solid #E5E7EB', padding: '18px', boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px' }}>
              <span style={{ fontSize: '12px', fontWeight: 600, color: '#64748B' }}>Holiday Calendar</span>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '6px' }}>
              <span style={{ fontSize: '11px', color: '#94A3B8' }}>Official Exclusions</span>
        ...
        <div style={{ background: '#FFFFFF', borderRadius: '16px', border: '1px solid #E5E7EB', padding: '20px', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
          <h3 style={{ fontFamily: PP, fontSize: '15px', fontWeight: 700, color: '#111827', margin: '0 0 16px 0', display: 'flex', alignItems: 'center', gap: '8px' }}>
            <Calendar size={18} style={{ color: '#0D47A1' }} /> Section 01: General Appointment Rules
          </h3>

          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '16px' }}>
            {[
              { label: 'Enable Online Appointment Booking', sub: 'Allow patients to book via Patient Portal & Mobile App', key: 'enableOnlineBooking' },
              { label: 'Appointment Approval Required', sub: 'Staff must confirm pending online booking requests', key: 'approvalRequired' },
              { label: 'Allow Walk-in Registration', sub: 'Enable reception desk counter walk-in tokens', key: 'allowWalkIn' },
              { label: 'Allow Same-Day Appointment', sub: 'Permit same-day slot bookings up to minimum hours', key: 'allowSameDay' },
              { label: 'Allow Future Advance Booking', sub: 'Patients can schedule appointments in advance', key: 'allowFutureBooking' },
            ].map((item, idx) => (
              <div key={idx} style={{ background: '#F8FAFC', padding: '12px 14px', borderRadius: '10px', border: '1px solid #E2E8F0', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <input
                  ...
                  onChange={e => setGeneralConfig(prev => ({ ...prev, [item.key]: e.target.checked }))}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            <div>
              ...
              <input
                ...
                onChange={e => setGeneralConfig(prev => ({ ...prev, maxAdvanceBookingDays: parseInt(e.target.value) || 0 }))}
            ...
            <div>
              ...
              <input
                ...
                onChange={e => setGeneralConfig(prev => ({ ...prev, minAdvanceBookingHours: parseInt(e.target.value) || 0 }))}
                style={{ width: '100%', padding: '10px 12px', borderRadius: '8px', border: '1px solid #D1D5DB', fontSize: '13px', boxSizing: 'border-box' }}
              />
            </div>
          </div>
        ...
        <div style={{ background: '#FFFFFF', borderRadius: '16px', border: '1px solid #E5E7EB', padding: '20px', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
          <h3 style={{ fontFamily: PP, fontSize: '15px', fontWeight: 700, color: '#111827', margin: '0 0 16px 0', display: 'flex', alignItems: 'center', gap: '8px' }}>
            <Clock size={18} style={{ color: '#009688' }} /> Section 02: Consultation Slot & Duration Parameters
          </h3>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '16px', marginBottom: '16px' }}>
            <div>
              ...
              <select
                ...
                onChange={e => setSlotConfig(prev => ({ ...prev, defaultDuration: e.target.value }))}
                style={{ width: '100%', padding: '10px 12px', borderRadius: '8px', border: '1px solid #D1D5DB', fontSize: '13px', boxSizing: 'border-box' }}
              >
            ...
            <div>
              ...
              <select
                ...
                onChange={e => setSlotConfig(prev => ({ ...prev, bufferTime: e.target.value }))}
                style={{ width: '100%', padding: '10px 12px', borderRadius: '8px', border: '1px solid #D1D5DB', fontSize: '13px', boxSizing: 'border-box' }}
              >
            ...
            <div>
              ...
              <input
                ...
                onChange={e => setSlotConfig(prev => ({ ...prev, maxPatientsPerSlot: parseInt(e.target.value) || 1 }))}
                style={{ width: '100%', padding: '10px 12px', borderRadius: '8px', border: '1px solid #D1D5DB', fontSize: '13px', boxSizing: 'border-box' }}
              />
            </div>
          </div>
          ...
          <div style={{ background: '#F8FAFC', padding: '12px 14px', borderRadius: '10px', border: '1px solid #E2E8F0', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div>
              <div style={{ fontSize: '13px', fontWeight: 600, color: '#111827' }}>Enable Double Booking Override</div>
              <div style={{ fontSize: '11px', color: '#64748B' }}>Allows senior doctors to accept urgent emergency patients in filled slots</div>
            </div>
            <input
              type="checkbox"
              checked={slotConfig.enableDoubleBooking}
              onChange={e => setSlotConfig(prev => ({ ...prev, enableDoubleBooking: e.target.checked }))}
              style={{ accentColor: '#0D47A1', width: '18px', height: '18px', cursor: 'pointer' }}
            />
          </div>
        </div>
        ...
        <div style={{ background: '#FFFFFF', borderRadius: '16px', border: '1px solid #E5E7EB', padding: '20px', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
          <h3 style={{ fontFamily: PP, fontSize: '15px', fontWeight: 700, color: '#111827', margin: '0 0 16px 0', display: 'flex', alignItems: 'center', gap: '8px' }}>
            <Calendar size={18} style={{ color: '#0D47A1' }} /> Section 03: OPD Weekly Working Hours Schedule
          </h3>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px', textAlign: 'left' }}>
              <thead>
                <tr style={{ background: '#F8FAFC', borderBottom: '1px solid #E5E7EB', color: '#475569', fontWeight: 600 }}>
                  ...
                  <th style={{ padding: '10px 14px', textAlign: 'right' }}>Toggle Day</th>
                </tr>
              </thead>
              <tbody>
                {workingHours.map((row, idx) => (
                  <tr key={row.day} style={{ borderBottom: '1px solid #F1F5F9', opacity: row.enabled ? 1 : 0.5 }}>
                    <td style={{ padding: '12px 14px', fontWeight: 700, color: '#111827' }}>{row.day}</td>
                    <td style={{ padding: '12px 14px' }}>
                      <input type="text" defaultValue={row.open} disabled={!row.enabled} style={{ padding: '4px 8px', borderRadius: '6px', border: '1px solid #D1D5DB', fontSize: '12px', width: '90px' }} />
                    </td>
                    <td style={{ padding: '12px 14px' }}>
                      <input type="text" defaultValue={row.close} disabled={!row.enabled} style={{ padding: '4px 8px', borderRadius: '6px', border: '1px solid #D1D5DB', fontSize: '12px', width: '90px' }} />
                    </td>
                    <td style={{ padding: '12px 14px' }}>
                      <input type="text" defaultValue={row.breakStart} disabled={!row.enabled} style={{ padding: '4px 8px', borderRadius: '6px', border: '1px solid #D1D5DB', fontSize: '12px', width: '90px' }} />
                    </td>
                    <td style={{ padding: '12px 14px' }}>
                      <input type="text" defaultValue={row.breakEnd} disabled={!row.enabled} style={{ padding: '4px 8px', borderRadius: '6px', border: '1px solid #D1D5DB', fontSize: '12px', width: '90px' }} />
                    </td>
                    <td style={{ padding: '12px 14px' }}>
                      <span style={{ fontSize: '11px', fontWeight: 600, padding: '2px 8px', borderRadius: '12px', background: row.enabled ? '#E8F5E9' : '#F1F5F9', color: row.enabled ? '#2E7D32' : '#64748B' }}>
                    ...
                    <td style={{ padding: '12px 14px', textAlign: 'right' }}>
                      <input
                        ...
                        style={{ accentColor: '#0D47A1', cursor: 'pointer', width: '16px', height: '16px' }}
                      />
                    </td>
                  </tr>
                ))}
        ...
        <div style={{ background: '#FFFFFF', borderRadius: '16px', border: '1px solid #E5E7EB', padding: '20px', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
          <h3 style={{ fontFamily: PP, fontSize: '15px', fontWeight: 700, color: '#111827', margin: '0 0 16px 0', display: 'flex', alignItems: 'center', gap: '8px' }}>
            <Sliders size={18} style={{ color: '#009688' }} /> Section 04: Queue & OPD Token Sequence Settings
          </h3>

          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '16px', marginBottom: '16px' }}>
            {[
              { label: 'Enable Token System', sub: 'Generate sequential OPD tokens', key: 'enableTokenSystem' },
              { label: 'Auto Token Generation', sub: 'Auto assign upon check-in', key: 'autoTokenGen' },
              { label: 'Queue Display Enabled', sub: 'Stream to waiting room TVs', key: 'queueDisplayEnabled' },
            ].map((item, idx) => (
              <div key={idx} style={{ background: '#F8FAFC', padding: '12px', borderRadius: '10px', border: '1px solid #E2E8F0', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <input
                  ...
                  onChange={e => setQueueConfig(prev => ({ ...prev, [item.key]: e.target.checked }))}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: '16px' }}>
            <div>
              <label style={{ display: 'block', fontSize: '12px', fontWeight: 600, color: '#374151', marginBottom: '6px' }}>Token Prefix</label>
              <input
                type="text"
            ...
            <div>
              <label style={{ display: 'block', fontSize: '12px', fontWeight: 600, color: '#374151', marginBottom: '6px' }}>Starting Token No.</label>
              <input
                type="number"
                value={queueConfig.startTokenNo}
                onChange={e => setQueueConfig(prev => ({ ...prev, startTokenNo: parseInt(e.target.value) || 101 }))}
                style={{ width: '100%', padding: '9px 12px', borderRadius: '8px', border: '1px solid #D1D5DB', fontSize: '13px', boxSizing: 'border-box' }}
              />
            </div>
            <div>
              <label style={{ display: 'block', fontSize: '12px', fontWeight: 600, color: '#374151', marginBottom: '6px' }}>Max Daily Queue Cap</label>
              <input
                type="number"
                value={queueConfig.maxQueueSize}
                onChange={e => setQueueConfig(prev => ({ ...prev, maxQueueSize: parseInt(e.target.value) || 200 }))}
                style={{ width: '100%', padding: '9px 12px', borderRadius: '8px', border: '1px solid #D1D5DB', fontSize: '13px', boxSizing: 'border-box' }}
              />
            </div>
            <div>
              <label style={{ display: 'block', fontSize: '12px', fontWeight: 600, color: '#374151', marginBottom: '6px' }}>Daily Queue Reset Time</label>
              <input
                type="text"
                value={queueConfig.queueResetTime}
                onChange={e => setQueueConfig(prev => ({ ...prev, queueResetTime: e.target.value }))}
                style={{ width: '100%', padding: '9px 12px', borderRadius: '8px', border: '1px solid #D1D5DB', fontSize: '13px', boxSizing: 'border-box' }}
              />
            </div>
          </div>
        ...
        <div style={{ background: '#FFFFFF', borderRadius: '16px', border: '1px solid #E5E7EB', padding: '20px', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
          <h3 style={{ fontFamily: PP, fontSize: '15px', fontWeight: 700, color: '#111827', margin: '0 0 16px 0', display: 'flex', alignItems: 'center', gap: '8px' }}>
            <Calendar size={18} style={{ color: '#0D47A1' }} /> Section 05: Official Holiday & Closure Calendar
          </h3>
          ...
          <div style={{ display: 'flex', gap: '10px', marginBottom: '16px' }}>
            ...
            <button
              ...
              style={{ padding: '8px 16px', borderRadius: '8px', border: 'none', background: '#0D47A1', color: '#FFFFFF', fontWeight: 600, fontSize: '13px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '4px' }}
            >
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '10px' }}>
            {holidays.map(h => (
              <div key={h.id} style={{ background: '#F8FAFC', padding: '10px 14px', borderRadius: '8px', border: '1px solid #E2E8F0', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <div>
                  <div style={{ fontSize: '13px', fontWeight: 700, color: '#111827' }}>{h.name}</div>
                  <div style={{ fontSize: '11px', color: '#64748B' }}>{h.date} • {h.type}</div>
                </div>
                <button onClick={() => handleRemoveHoliday(h.id)} style={{ border: 'none', background: 'transparent', color: '#EF4444', cursor: 'pointer', padding: '4px' }}>
                  <Trash2 size={16} />
                </button>
              </div>
            ))}
        ...
        <div style={{ background: '#FFFFFF', borderRadius: '16px', border: '1px solid #E5E7EB', padding: '20px', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
          <h3 style={{ fontFamily: PP, fontSize: '15px', fontWeight: 700, color: '#111827', margin: '0 0 16px 0', display: 'flex', alignItems: 'center', gap: '8px' }}>
            <CheckCircle2 size={18} style={{ color: '#009688' }} /> Section 06: Appointment Status Lifecycle Rules
          </h3>

          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px' }}>
            {statuses.map((st, i) => (
              <div key={st.id} style={{ background: '#F8FAFC', border: '1px solid #E2E8F0', padding: '12px', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <input
                    ...
                    style={{ border: '1px solid #D1D5DB', borderRadius: '6px', padding: '4px 8px', fontSize: '12px', fontWeight: 600, color: '#111827', width: '120px' }}
                  />
                </div>
                <input
                  type="checkbox"
        ...
        <div style={{ background: '#FFFFFF', borderRadius: '16px', border: '1px solid #E5E7EB', padding: '20px', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
          <h3 style={{ fontFamily: PP, fontSize: '16px', fontWeight: 700, color: '#111827', margin: '0 0 16px 0', display: 'flex', alignItems: 'center', gap: '8px' }}>
            <BarChart2 size={18} style={{ color: '#0D47A1' }} /> Appointment Volume Analytics
          </h3>

          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            {/* Bar Chart Mock */}
            <div style={{ background: '#F8FAFC', borderRadius: '12px', padding: '16px', border: '1px solid #E2E8F0' }}>
              <h4 style={{ fontSize: '13px', fontWeight: 700, color: '#111827', margin: '0 0 12px 0' }}>Appointments by Day of Week</h4>
                ...
                {[
                  ...
                  <div key={idx}>
                    ...
                    <div style={{ width: '100%', height: '8px', background: '#E2E8F0', borderRadius: '4px', overflow: 'hidden' }}>
                      <div style={{ width: `${(item.count / 160) * 100}%`, height: '100%', background: item.color }} />
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div style={{ background: '#F8FAFC', borderRadius: '12px', padding: '16px', border: '1px solid #E2E8F0' }}>
              <h4 style={{ fontSize: '13px', fontWeight: 700, color: '#111827', margin: '0 0 12px 0', display: 'flex', alignItems: 'center', gap: '6px' }}>
                <PieChartIcon size={14} style={{ color: '#009688' }} /> Status Distribution Breakdown
              </h4>
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px', height: '120px' }}>
                <div style={{ width: '90px', height: '90px', borderRadius: '50%', background: 'conic-gradient(#66BB6A 0% 60%, #0D47A1 60% 80%, #F59E0B 80% 92%, #EF4444 92% 100%)' }} />
                <div style={{ fontSize: '11px', display: 'flex', flexDirection: 'column', gap: '4px' }}>
                  <span style={{ color: '#66BB6A', fontWeight: 600 }}>■ Completed (60%)</span>
                  <span style={{ color: '#0D47A1', fontWeight: 600 }}>■ Scheduled (20%)</span>
                  <span style={{ color: '#F59E0B', fontWeight: 600 }}>■ Waiting (12%)</span>
                  <span style={{ color: '#EF4444', fontWeight: 600 }}>■ Cancelled (8%)</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div style={{ background: '#FFFFFF', borderRadius: '16px', border: '1px solid #E5E7EB', padding: '20px', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
          <h3 style={{ fontFamily: PP, fontSize: '15px', fontWeight: 700, color: '#111827', margin: '0 0 16px 0', display: 'flex', alignItems: 'center', gap: '8px' }}>
            <Eye size={18} style={{ color: '#0D47A1' }} /> Section 08: Configured Appointment Lifecycle Flow
          </h3>
      ...
      {showPreviewModal && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 100, padding: '20px' }}>
          <div style={{ background: '#FFFFFF', borderRadius: '16px', maxWidth: '650px', width: '100%', padding: '24px', boxShadow: '0 20px 25px -5px rgba(0,0,0,0.1)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '8px', maxHeight: '300px', overflowY: 'auto', padding: '8px' }}>
              {['08:00 AM', '08:15 AM', '08:30 AM', '08:45 AM', '09:00 AM', '09:15 AM', '09:30 AM', '09:45 AM', '10:00 AM', '10:15 AM', '10:30 AM', '10:45 AM', '11:00 AM', '11:15 AM', '11:30 AM', '11:45 AM'].map((time, idx) => (
                <div key={idx} style={{ background: idx % 3 === 0 ? '#E3F2FD' : '#FFFFFF', border: '1px solid #CBD5E1', padding: '8px', borderRadius: '6px', textTransform: 'uppercase', textAlign: 'center', fontSize: '11px', fontWeight: 600, color: idx % 3 === 0 ? '#0D47A1' : '#475569' }}>
                  {time} <br />
                  <span style={{ fontSize: '9px', fontWeight: 400 }}>{idx % 3 === 0 ? 'Booked' : 'Available'}</span>
                </div>
              ))}
            </div>
